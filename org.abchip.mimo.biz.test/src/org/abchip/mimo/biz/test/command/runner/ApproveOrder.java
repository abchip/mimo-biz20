...
public class ApproveOrder implements Callable<Long> {

	private static final Logger LOGGER = Logs.getLogger(ApproveOrder.class);
	Context context;
	String orderId;

	public ApproveOrder(Context context, String orderId) {
