...
import org.abchip.mimo.biz.model.catalina.session.SessionFactory;
...
public class SessionPackageImpl extends EPackageImpl implements SessionPackage {
	 ...
	 * @generated
	 */
	private EClass catalinaSessionEClass = null;
	 ...
	 * @see org.abchip.mimo.biz.model.catalina.session.SessionPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	 ...
	 *
	 * <p>This method is used to initialize {@link SessionPackage#eINSTANCE} when that field is accessed.
	...
	public static SessionPackage init() {
		if (isInited) return (SessionPackage)EPackage.Registry.INSTANCE.getEPackage(SessionPackage.eNS_URI);

		// Obtain or create and register package
		Object registeredSessionPackage = EPackage.Registry.INSTANCE.get(eNS_URI);
		SessionPackageImpl theSessionPackage = registeredSessionPackage instanceof SessionPackageImpl ? (SessionPackageImpl)registeredSessionPackage : new SessionPackageImpl();
	 ...
	 */
	@Override
	public EClass getCatalinaSession() {
		return catalinaSessionEClass;
	}
	 ...
	 */
	@Override
	public EAttribute getCatalinaSession_SessionId() {
		return (EAttribute)catalinaSessionEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 */
	@Override
	public EAttribute getCatalinaSession_IsValid() {
		return (EAttribute)catalinaSessionEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 */
	@Override
	public EAttribute getCatalinaSession_LastAccessed() {
		return (EAttribute)catalinaSessionEClass.getEStructuralFeatures().get(2);
	}
	 ...
	 */
	@Override
	public EAttribute getCatalinaSession_MaxIdle() {
		return (EAttribute)catalinaSessionEClass.getEStructuralFeatures().get(3);
	}
	 ...
	 */
	@Override
	public EAttribute getCatalinaSession_SessionInfo() {
		return (EAttribute)catalinaSessionEClass.getEStructuralFeatures().get(4);
	}
	 ...
	 */
	@Override
	public EAttribute getCatalinaSession_SessionSize() {
		return (EAttribute)catalinaSessionEClass.getEStructuralFeatures().get(5);
	}
	...
	public void createPackageContents() {
		...
		catalinaSessionEClass = createEClass(CATALINA_SESSION);
		createEAttribute(catalinaSessionEClass, CATALINA_SESSION__SESSION_ID);
		createEAttribute(catalinaSessionEClass, CATALINA_SESSION__IS_VALID);
		createEAttribute(catalinaSessionEClass, CATALINA_SESSION__LAST_ACCESSED);
		createEAttribute(catalinaSessionEClass, CATALINA_SESSION__MAX_IDLE);
		createEAttribute(catalinaSessionEClass, CATALINA_SESSION__SESSION_INFO);
		createEAttribute(catalinaSessionEClass, CATALINA_SESSION__SESSION_SIZE);
	}
	...
	public void initializePackageContents() {
		...
		catalinaSessionEClass.getESuperTypes().add(theEntityPackage_1.getEntityIdentifiable());
		catalinaSessionEClass.getESuperTypes().add(theEntityPackage_1.getEntityInfo());
