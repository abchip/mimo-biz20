...
import org.abchip.mimo.biz.model.shipment.issuance.IssuanceFactory;
 ...
 * @generated
 */
public class IssuancePackageImpl extends EPackageImpl implements IssuancePackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private EClass itemIssuanceEClass = null;
	 ...
	 * @generated
	 */
	private EClass itemIssuanceRoleEClass = null;
	 ...
	 * @see org.abchip.mimo.biz.model.shipment.issuance.IssuancePackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private IssuancePackageImpl() {
		super(eNS_URI, IssuanceFactory.eINSTANCE);
	}
	 ...
	 *
	 * <p>This method is used to initialize {@link IssuancePackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static IssuancePackage init() {
		if (isInited) return (IssuancePackage)EPackage.Registry.INSTANCE.getEPackage(IssuancePackage.eNS_URI);

		// Obtain or create and register package
		Object registeredIssuancePackage = EPackage.Registry.INSTANCE.get(eNS_URI);
		IssuancePackageImpl theIssuancePackage = registeredIssuancePackage instanceof IssuancePackageImpl ? (IssuancePackageImpl)registeredIssuancePackage : new IssuancePackageImpl();
		...
		theIssuancePackage.freeze();

		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(IssuancePackage.eNS_URI, theIssuancePackage);
		return theIssuancePackage;
	}
	 ...
	 */
	@Override
	public EClass getItemIssuance() {
		return itemIssuanceEClass;
	}
	 ...
	 */
	@Override
	public EAttribute getItemIssuance_ItemIssuanceId() {
		return (EAttribute)itemIssuanceEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 */
	@Override
	public EAttribute getItemIssuance_CancelQuantity() {
		return (EAttribute)itemIssuanceEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 */
	@Override
	public EAttribute getItemIssuance_FixedAssetId() {
		return (EAttribute)itemIssuanceEClass.getEStructuralFeatures().get(2);
	}
	 ...
	 */
	@Override
	public EClass getItemIssuanceRole() {
		return itemIssuanceRoleEClass;
	}
	 ...
	 */
	@Override
	public IssuanceFactory getIssuanceFactory() {
		return (IssuanceFactory)getEFactoryInstance();
	}
	...
	public void createPackageContents() {
		...
		itemIssuanceEClass = createEClass(ITEM_ISSUANCE);
