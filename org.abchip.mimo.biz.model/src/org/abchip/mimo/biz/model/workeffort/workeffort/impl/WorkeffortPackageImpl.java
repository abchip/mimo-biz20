...
public class WorkeffortPackageImpl extends EPackageImpl implements WorkeffortPackage {
	...
	public void initializePackageContents() {
		...
		deliverableEClass.getESuperTypes().add(theEntityPackage_1.getEntityIdentifiable());
		deliverableEClass.getESuperTypes().add(theEntityPackage_1.getEntityInfo());
		deliverableTypeEClass.getESuperTypes().add(theEntityPackage_1.getEntityIdentifiable());
		deliverableTypeEClass.getESuperTypes().add(theEntityPackage_1.getEntityInfo());
		...
		workEffortContentEClass.getESuperTypes().add(theEntityPackage_1.getEntityIdentifiable());
		workEffortContentEClass.getESuperTypes().add(theEntityPackage_1.getEntityInfo());
		workEffortContentTypeEClass.getESuperTypes().add(theEntityPackage_1.getEntityIdentifiable());
		workEffortContentTypeEClass.getESuperTypes().add(theEntityPackage_1.getEntityInfo());
