...
import org.abchip.mimo.biz.model.service.semaphore.SemaphoreFactory;
 ...
 * @generated
 */
public class SemaphorePackageImpl extends EPackageImpl implements SemaphorePackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private EClass serviceSemaphoreEClass = null;
	 ...
	 * @see org.abchip.mimo.biz.model.service.semaphore.SemaphorePackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private SemaphorePackageImpl() {
		super(eNS_URI, SemaphoreFactory.eINSTANCE);
	}
	 ...
	 *
	 * <p>This method is used to initialize {@link SemaphorePackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static SemaphorePackage init() {
		if (isInited) return (SemaphorePackage)EPackage.Registry.INSTANCE.getEPackage(SemaphorePackage.eNS_URI);

		// Obtain or create and register package
		Object registeredSemaphorePackage = EPackage.Registry.INSTANCE.get(eNS_URI);
		SemaphorePackageImpl theSemaphorePackage = registeredSemaphorePackage instanceof SemaphorePackageImpl ? (SemaphorePackageImpl)registeredSemaphorePackage : new SemaphorePackageImpl();
		...
		theSemaphorePackage.freeze();

		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(SemaphorePackage.eNS_URI, theSemaphorePackage);
		return theSemaphorePackage;
	}
	 ...
	 */
	@Override
	public EClass getServiceSemaphore() {
		return serviceSemaphoreEClass;
	}
	 ...
	 */
	@Override
	public EAttribute getServiceSemaphore_ServiceName() {
		return (EAttribute)serviceSemaphoreEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 */
	@Override
	public EAttribute getServiceSemaphore_LockThread() {
		return (EAttribute)serviceSemaphoreEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 */
	@Override
	public EAttribute getServiceSemaphore_LockTime() {
		return (EAttribute)serviceSemaphoreEClass.getEStructuralFeatures().get(2);
	}
	 ...
	 */
	@Override
	public EAttribute getServiceSemaphore_LockedByInstanceId() {
		return (EAttribute)serviceSemaphoreEClass.getEStructuralFeatures().get(3);
	}
	 ...
	 */
	@Override
	public SemaphoreFactory getSemaphoreFactory() {
		return (SemaphoreFactory)getEFactoryInstance();
	}
	...
	public void createPackageContents() {
		...
		serviceSemaphoreEClass = createEClass(SERVICE_SEMAPHORE);
		createEAttribute(serviceSemaphoreEClass, SERVICE_SEMAPHORE__SERVICE_NAME);
		createEAttribute(serviceSemaphoreEClass, SERVICE_SEMAPHORE__LOCK_THREAD);
		createEAttribute(serviceSemaphoreEClass, SERVICE_SEMAPHORE__LOCK_TIME);
		createEAttribute(serviceSemaphoreEClass, SERVICE_SEMAPHORE__LOCKED_BY_INSTANCE_ID);
	}
	...
	public void initializePackageContents() {
		...
		initEAttribute(getServiceSemaphore_LockTime(), ecorePackage.getEDate(), "lockTime", null, 0, 1, ServiceSemaphore.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
