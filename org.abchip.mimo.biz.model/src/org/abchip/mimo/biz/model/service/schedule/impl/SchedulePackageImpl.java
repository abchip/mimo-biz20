...
import org.abchip.mimo.biz.model.service.schedule.ScheduleFactory;
...
public class SchedulePackageImpl extends EPackageImpl implements SchedulePackage {
	 ...
	 * @generated
	 */
	private EClass jobManagerLockEClass = null;
	 ...
	 * @generated
	 */
	private EClass jobSandboxEClass = null;
	 ...
	 * @generated
	 */
	private EClass recurrenceInfoEClass = null;
	 ...
	 * @generated
	 */
	private EClass recurrenceRuleEClass = null;
	 ...
	 * @generated
	 */
	private EClass temporalExpressionAssocEClass = null;
	 ...
	 * @see org.abchip.mimo.biz.model.service.schedule.SchedulePackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	 ...
	 */
	@Override
	public EClass getJobManagerLock() {
		return jobManagerLockEClass;
	}
	 ...
	 */
	@Override
	public EAttribute getJobManagerLock_InstanceId() {
		return (EAttribute)jobManagerLockEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 */
	@Override
	public EAttribute getJobManagerLock_FromDate() {
		return (EAttribute)jobManagerLockEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 */
	@Override
	public EAttribute getJobManagerLock_Comments() {
		return (EAttribute)jobManagerLockEClass.getEStructuralFeatures().get(2);
	}
	 ...
	 */
	@Override
	public EAttribute getJobManagerLock_CreatedByUserLogin() {
		return (EAttribute)jobManagerLockEClass.getEStructuralFeatures().get(3);
	}
	 ...
	 */
	@Override
	public EAttribute getJobManagerLock_CreatedDate() {
		return (EAttribute)jobManagerLockEClass.getEStructuralFeatures().get(4);
	}
	 ...
	 */
	@Override
	public EAttribute getJobManagerLock_LastModifiedByUserLogin() {
		return (EAttribute)jobManagerLockEClass.getEStructuralFeatures().get(5);
	}
	 ...
	 */
	@Override
	public EAttribute getJobManagerLock_LastModifiedDate() {
		return (EAttribute)jobManagerLockEClass.getEStructuralFeatures().get(6);
	}
	 ...
	 */
	@Override
	public EAttribute getJobManagerLock_ThruDate() {
		return (EAttribute)jobManagerLockEClass.getEStructuralFeatures().get(8);
	}
	 ...
	 */
	@Override
	public EClass getJobSandbox() {
		return jobSandboxEClass;
	}
	 ...
	 */
	@Override
	public EAttribute getJobSandbox_JobId() {
		return (EAttribute)jobSandboxEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 */
	@Override
	public EAttribute getJobSandbox_CancelDateTime() {
		return (EAttribute)jobSandboxEClass.getEStructuralFeatures().get(2);
	}
	 ...
	 */
	@Override
	public EAttribute getJobSandbox_CurrentRecurrenceCount() {
		return (EAttribute)jobSandboxEClass.getEStructuralFeatures().get(3);
	}
	 ...
	 */
	@Override
	public EAttribute getJobSandbox_CurrentRetryCount() {
		return (EAttribute)jobSandboxEClass.getEStructuralFeatures().get(4);
	}
	 ...
	 */
	@Override
	public EAttribute getJobSandbox_FinishDateTime() {
		return (EAttribute)jobSandboxEClass.getEStructuralFeatures().get(5);
	}
	 ...
	 */
	@Override
	public EAttribute getJobSandbox_JobName() {
		return (EAttribute)jobSandboxEClass.getEStructuralFeatures().get(6);
	}
	 ...
	 */
	@Override
	public EAttribute getJobSandbox_JobResult() {
		return (EAttribute)jobSandboxEClass.getEStructuralFeatures().get(7);
	}
	 ...
	 */
	@Override
	public EAttribute getJobSandbox_LoaderName() {
		return (EAttribute)jobSandboxEClass.getEStructuralFeatures().get(8);
	}
	 ...
	 */
	@Override
	public EAttribute getJobSandbox_MaxRecurrenceCount() {
		return (EAttribute)jobSandboxEClass.getEStructuralFeatures().get(9);
	}
	 ...
	 */
	@Override
	public EAttribute getJobSandbox_MaxRetry() {
		return (EAttribute)jobSandboxEClass.getEStructuralFeatures().get(10);
	}
	 ...
	 */
	@Override
	public EAttribute getJobSandbox_ParentJobId() {
		return (EAttribute)jobSandboxEClass.getEStructuralFeatures().get(11);
	}
	 ...
	 */
	@Override
	public EAttribute getJobSandbox_PoolId() {
		return (EAttribute)jobSandboxEClass.getEStructuralFeatures().get(12);
	}
	 ...
	 */
	@Override
	public EAttribute getJobSandbox_PreviousJobId() {
		return (EAttribute)jobSandboxEClass.getEStructuralFeatures().get(13);
	}
	 ...
	 */
	@Override
	public EReference getJobSandbox_RunAsUser() {
		return (EReference)jobSandboxEClass.getEStructuralFeatures().get(15);
	}
	 ...
	 */
	@Override
	public EAttribute getJobSandbox_RunByInstanceId() {
		return (EAttribute)jobSandboxEClass.getEStructuralFeatures().get(16);
	}
	 ...
	 */
	@Override
	public EAttribute getJobSandbox_RunTime() {
		return (EAttribute)jobSandboxEClass.getEStructuralFeatures().get(17);
	}
	 ...
	 */
	@Override
	public EAttribute getJobSandbox_ServiceName() {
		return (EAttribute)jobSandboxEClass.getEStructuralFeatures().get(19);
	}
	 ...
	 */
	@Override
	public EAttribute getJobSandbox_StartDateTime() {
		return (EAttribute)jobSandboxEClass.getEStructuralFeatures().get(20);
	}
	 ...
	 */
	@Override
	public EClass getRecurrenceInfo() {
		return recurrenceInfoEClass;
	}
	 ...
	 */
	@Override
	public EAttribute getRecurrenceInfo_RecurrenceInfoId() {
		return (EAttribute)recurrenceInfoEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 */
	@Override
	public EAttribute getRecurrenceInfo_ExceptionDateTimes() {
		return (EAttribute)recurrenceInfoEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 */
	@Override
	public EAttribute getRecurrenceInfo_RecurrenceCount() {
		return (EAttribute)recurrenceInfoEClass.getEStructuralFeatures().get(3);
	}
	 ...
	 */
	@Override
	public EAttribute getRecurrenceInfo_RecurrenceDateTimes() {
		return (EAttribute)recurrenceInfoEClass.getEStructuralFeatures().get(4);
	}
	 ...
	 */
	@Override
	public EAttribute getRecurrenceInfo_StartDateTime() {
		return (EAttribute)recurrenceInfoEClass.getEStructuralFeatures().get(6);
	}
	 ...
	 */
	@Override
	public EClass getRecurrenceRule() {
		return recurrenceRuleEClass;
	}
	 ...
	 */
	@Override
	public EAttribute getRecurrenceRule_RecurrenceRuleId() {
		return (EAttribute)recurrenceRuleEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 */
	@Override
	public EAttribute getRecurrenceRule_ByDayList() {
		return (EAttribute)recurrenceRuleEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 */
	@Override
	public EAttribute getRecurrenceRule_ByHourList() {
		return (EAttribute)recurrenceRuleEClass.getEStructuralFeatures().get(2);
	}
	 ...
	 */
	@Override
	public EAttribute getRecurrenceRule_ByMinuteList() {
		return (EAttribute)recurrenceRuleEClass.getEStructuralFeatures().get(3);
	}
	 ...
	 */
	@Override
	public EAttribute getRecurrenceRule_ByMonthDayList() {
		return (EAttribute)recurrenceRuleEClass.getEStructuralFeatures().get(4);
	}
	 ...
	 */
	@Override
	public EAttribute getRecurrenceRule_ByMonthList() {
		return (EAttribute)recurrenceRuleEClass.getEStructuralFeatures().get(5);
	}
	 ...
	 */
	@Override
	public EAttribute getRecurrenceRule_BySecondList() {
		return (EAttribute)recurrenceRuleEClass.getEStructuralFeatures().get(6);
	}
	 ...
	 */
	@Override
	public EAttribute getRecurrenceRule_BySetPosList() {
		return (EAttribute)recurrenceRuleEClass.getEStructuralFeatures().get(7);
	}
	 ...
	 */
	@Override
	public EAttribute getRecurrenceRule_ByWeekNoList() {
		return (EAttribute)recurrenceRuleEClass.getEStructuralFeatures().get(8);
	}
	 ...
	 */
	@Override
	public EAttribute getRecurrenceRule_ByYearDayList() {
		return (EAttribute)recurrenceRuleEClass.getEStructuralFeatures().get(9);
	}
	 ...
	 */
	@Override
	public EAttribute getRecurrenceRule_CountNumber() {
		return (EAttribute)recurrenceRuleEClass.getEStructuralFeatures().get(10);
	}
	 ...
	 */
	@Override
	public EAttribute getRecurrenceRule_Frequency() {
		return (EAttribute)recurrenceRuleEClass.getEStructuralFeatures().get(11);
	}
	 ...
	 */
	@Override
	public EAttribute getRecurrenceRule_IntervalNumber() {
		return (EAttribute)recurrenceRuleEClass.getEStructuralFeatures().get(12);
	}
	 ...
	 */
	@Override
	public EAttribute getRecurrenceRule_UntilDateTime() {
		return (EAttribute)recurrenceRuleEClass.getEStructuralFeatures().get(13);
	}
	 ...
	 */
	@Override
	public EAttribute getRecurrenceRule_WeekStart() {
		return (EAttribute)recurrenceRuleEClass.getEStructuralFeatures().get(14);
	}
	 ...
	 */
	@Override
	public EAttribute getRecurrenceRule_XName() {
		return (EAttribute)recurrenceRuleEClass.getEStructuralFeatures().get(15);
	}
	 ...
	 */
	@Override
	public EAttribute getRuntimeData_RuntimeDataId() {
		return (EAttribute)runtimeDataEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 */
	@Override
	public EAttribute getRuntimeData_RuntimeInfo() {
		return (EAttribute)runtimeDataEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 */
	@Override
	public EAttribute getTemporalExpression_TempExprId() {
		return (EAttribute)temporalExpressionEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 */
	@Override
	public EAttribute getTemporalExpression_Date1() {
		return (EAttribute)temporalExpressionEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 */
	@Override
	public EAttribute getTemporalExpression_Date2() {
		return (EAttribute)temporalExpressionEClass.getEStructuralFeatures().get(2);
	}
	 ...
	 */
	@Override
	public EAttribute getTemporalExpression_Description() {
		return (EAttribute)temporalExpressionEClass.getEStructuralFeatures().get(3);
	}
	 ...
	 */
	@Override
	public EClass getTemporalExpressionAssoc() {
		return temporalExpressionAssocEClass;
	}
	...
	public EAttribute getTemporalExpressionAssoc_ExprAssocType() {
		return (EAttribute)temporalExpressionAssocEClass.getEStructuralFeatures().get(2);
	}
	...
	public void createPackageContents() {
		...
		jobManagerLockEClass = createEClass(JOB_MANAGER_LOCK);
		createEAttribute(jobManagerLockEClass, JOB_MANAGER_LOCK__FROM_DATE);
		createEAttribute(jobManagerLockEClass, JOB_MANAGER_LOCK__INSTANCE_ID);
		createEAttribute(jobManagerLockEClass, JOB_MANAGER_LOCK__COMMENTS);
		createEAttribute(jobManagerLockEClass, JOB_MANAGER_LOCK__CREATED_BY_USER_LOGIN);
		...
		createEAttribute(jobSandboxEClass, JOB_SANDBOX__FINISH_DATE_TIME);
		createEAttribute(jobSandboxEClass, JOB_SANDBOX__JOB_NAME);
		createEAttribute(jobSandboxEClass, JOB_SANDBOX__JOB_RESULT);
		createEAttribute(jobSandboxEClass, JOB_SANDBOX__LOADER_NAME);
		createEAttribute(jobSandboxEClass, JOB_SANDBOX__MAX_RECURRENCE_COUNT);
		createEAttribute(jobSandboxEClass, JOB_SANDBOX__MAX_RETRY);
		...
		createEAttribute(recurrenceRuleEClass, RECURRENCE_RULE__RECURRENCE_RULE_ID);
		createEAttribute(recurrenceRuleEClass, RECURRENCE_RULE__BY_DAY_LIST);
		createEAttribute(recurrenceRuleEClass, RECURRENCE_RULE__BY_HOUR_LIST);
		createEAttribute(recurrenceRuleEClass, RECURRENCE_RULE__BY_MINUTE_LIST);
		createEAttribute(recurrenceRuleEClass, RECURRENCE_RULE__BY_MONTH_DAY_LIST);
		createEAttribute(recurrenceRuleEClass, RECURRENCE_RULE__BY_MONTH_LIST);
		createEAttribute(recurrenceRuleEClass, RECURRENCE_RULE__BY_SECOND_LIST);
		createEAttribute(recurrenceRuleEClass, RECURRENCE_RULE__BY_SET_POS_LIST);
		createEAttribute(recurrenceRuleEClass, RECURRENCE_RULE__BY_WEEK_NO_LIST);
		createEAttribute(recurrenceRuleEClass, RECURRENCE_RULE__BY_YEAR_DAY_LIST);
		createEAttribute(recurrenceRuleEClass, RECURRENCE_RULE__COUNT_NUMBER);
		createEAttribute(recurrenceRuleEClass, RECURRENCE_RULE__FREQUENCY);
		createEAttribute(recurrenceRuleEClass, RECURRENCE_RULE__INTERVAL_NUMBER);
		createEAttribute(recurrenceRuleEClass, RECURRENCE_RULE__UNTIL_DATE_TIME);
		createEAttribute(recurrenceRuleEClass, RECURRENCE_RULE__WEEK_START);
		createEAttribute(recurrenceRuleEClass, RECURRENCE_RULE__XNAME);

		runtimeDataEClass = createEClass(RUNTIME_DATA);
		createEAttribute(runtimeDataEClass, RUNTIME_DATA__RUNTIME_DATA_ID);
		createEAttribute(runtimeDataEClass, RUNTIME_DATA__RUNTIME_INFO);

		temporalExpressionEClass = createEClass(TEMPORAL_EXPRESSION);
		createEAttribute(temporalExpressionEClass, TEMPORAL_EXPRESSION__TEMP_EXPR_ID);
		...
		createEAttribute(temporalExpressionEClass, TEMPORAL_EXPRESSION__STRING2);
	...
	public void initializePackageContents() {
		...
		initEAttribute(getJobManagerLock_FromDate(), ecorePackage.getEDate(), "fromDate", null, 1, 1, JobManagerLock.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getJobManagerLock_InstanceId(), ecorePackage.getEString(), "instanceId", null, 1, 1, JobManagerLock.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getJobManagerLock_Comments(), ecorePackage.getEString(), "comments", null, 0, 1, JobManagerLock.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getJobManagerLock_CreatedByUserLogin(), ecorePackage.getEString(), "createdByUserLogin", null, 0, 1, JobManagerLock.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getJobSandbox_FinishDateTime(), ecorePackage.getEDate(), "finishDateTime", null, 0, 1, JobSandbox.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getJobSandbox_JobName(), ecorePackage.getEString(), "jobName", null, 0, 1, JobSandbox.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getJobSandbox_JobResult(), ecorePackage.getEString(), "jobResult", null, 0, 1, JobSandbox.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getJobSandbox_LoaderName(), ecorePackage.getEString(), "loaderName", null, 0, 1, JobSandbox.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getJobSandbox_MaxRecurrenceCount(), ecorePackage.getELong(), "maxRecurrenceCount", null, 0, 1, JobSandbox.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getJobSandbox_MaxRetry(), ecorePackage.getELong(), "maxRetry", null, 0, 1, JobSandbox.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getRecurrenceRule_ByDayList(), ecorePackage.getEString(), "byDayList", null, 0, 1, RecurrenceRule.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getRecurrenceRule_ByHourList(), ecorePackage.getEString(), "byHourList", null, 0, 1, RecurrenceRule.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getRecurrenceRule_ByMinuteList(), ecorePackage.getEString(), "byMinuteList", null, 0, 1, RecurrenceRule.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getRecurrenceRule_ByMonthDayList(), ecorePackage.getEString(), "byMonthDayList", null, 0, 1, RecurrenceRule.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getRecurrenceRule_ByMonthList(), ecorePackage.getEString(), "byMonthList", null, 0, 1, RecurrenceRule.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getRecurrenceRule_BySecondList(), ecorePackage.getEString(), "bySecondList", null, 0, 1, RecurrenceRule.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getRecurrenceRule_BySetPosList(), ecorePackage.getEString(), "bySetPosList", null, 0, 1, RecurrenceRule.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getRecurrenceRule_ByWeekNoList(), ecorePackage.getEString(), "byWeekNoList", null, 0, 1, RecurrenceRule.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getRecurrenceRule_ByYearDayList(), ecorePackage.getEString(), "byYearDayList", null, 0, 1, RecurrenceRule.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getRecurrenceRule_CountNumber(), ecorePackage.getELong(), "countNumber", null, 0, 1, RecurrenceRule.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getRecurrenceRule_Frequency(), ecorePackage.getEString(), "frequency", null, 0, 1, RecurrenceRule.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getRecurrenceRule_IntervalNumber(), ecorePackage.getELong(), "intervalNumber", null, 0, 1, RecurrenceRule.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getRecurrenceRule_UntilDateTime(), ecorePackage.getEDate(), "untilDateTime", null, 0, 1, RecurrenceRule.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
	...
	protected void createMimoentframeAnnotations() {
		...
		addAnnotation
		  (temporalExpressionEClass,
		   source,
		   new String[] {
			   "formula", "description"
		   });
		addAnnotation
		  (temporalExpressionAssocEClass,
		   source,
		   new String[] {
