...
import org.abchip.mimo.biz.model.order.reservations.ReservationsFactory;
 ...
 * @generated
 */
public class ReservationsPackageImpl extends EPackageImpl implements ReservationsPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private EClass accommodationSpotEClass = null;
	 ...
	 * @see org.abchip.mimo.biz.model.order.reservations.ReservationsPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private ReservationsPackageImpl() {
		super(eNS_URI, ReservationsFactory.eINSTANCE);
	}
	 ...
	 *
	 * <p>This method is used to initialize {@link ReservationsPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static ReservationsPackage init() {
		if (isInited) return (ReservationsPackage)EPackage.Registry.INSTANCE.getEPackage(ReservationsPackage.eNS_URI);

		// Obtain or create and register package
		Object registeredReservationsPackage = EPackage.Registry.INSTANCE.get(eNS_URI);
		ReservationsPackageImpl theReservationsPackage = registeredReservationsPackage instanceof ReservationsPackageImpl ? (ReservationsPackageImpl)registeredReservationsPackage : new ReservationsPackageImpl();
		...
		theReservationsPackage.freeze();

		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(ReservationsPackage.eNS_URI, theReservationsPackage);
		return theReservationsPackage;
	}
	 ...
	 */
	@Override
	public EClass getAccommodationSpot() {
		return accommodationSpotEClass;
	}
	 ...
	 */
	@Override
	public EAttribute getAccommodationSpot_AccommodationSpotId() {
		return (EAttribute)accommodationSpotEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 */
	@Override
	public EReference getAccommodationSpot_AccommodationClass() {
	 ...
	 */
	@Override
	public EReference getAccommodationSpot_FixedAsset() {
	 ...
	 */
	@Override
	public ReservationsFactory getReservationsFactory() {
		return (ReservationsFactory)getEFactoryInstance();
	}
	...
	public void createPackageContents() {
		...
		createEReference(accommodationSpotEClass, ACCOMMODATION_SPOT__ACCOMMODATION_CLASS);
		createEAttribute(accommodationSpotEClass, ACCOMMODATION_SPOT__DESCRIPTION);
		createEReference(accommodationSpotEClass, ACCOMMODATION_SPOT__FIXED_ASSET);
	...
	public void initializePackageContents() {
		...
		initEReference(getAccommodationSpot_AccommodationClass(), theFixedassetPackage.getAccommodationClass(), null, "accommodationClass", null, 0, 1, AccommodationSpot.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		getAccommodationSpot_AccommodationClass().getEKeys().add(theFixedassetPackage.getAccommodationClass_AccommodationClassId());
		...
		initEReference(getAccommodationSpot_FixedAsset(), theFixedassetPackage.getFixedAsset(), null, "fixedAsset", null, 0, 1, AccommodationSpot.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		getAccommodationSpot_FixedAsset().getEKeys().add(theFixedassetPackage.getFixedAsset_FixedAssetId());
