...
import org.abchip.mimo.biz.model.order.shoppinglist.ShoppinglistFactory;
 ...
 * @generated
 */
public class ShoppinglistPackageImpl extends EPackageImpl implements ShoppinglistPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private EClass shoppingListEClass = null;
	 ...
	 * @generated
	 */
	private EClass shoppingListItemEClass = null;
	 ...
	 * @generated
	 */
	private EClass shoppingListItemSurveyEClass = null;
	 ...
	 * @generated
	 */
	private EClass shoppingListTypeEClass = null;
	 ...
	 * @generated
	 */
	private EClass shoppingListWorkEffortEClass = null;
	 ...
	 * @see org.abchip.mimo.biz.model.order.shoppinglist.ShoppinglistPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private ShoppinglistPackageImpl() {
		super(eNS_URI, ShoppinglistFactory.eINSTANCE);
	}
	 ...
	 *
	 * <p>This method is used to initialize {@link ShoppinglistPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static ShoppinglistPackage init() {
		if (isInited) return (ShoppinglistPackage)EPackage.Registry.INSTANCE.getEPackage(ShoppinglistPackage.eNS_URI);

		// Obtain or create and register package
		Object registeredShoppinglistPackage = EPackage.Registry.INSTANCE.get(eNS_URI);
		ShoppinglistPackageImpl theShoppinglistPackage = registeredShoppinglistPackage instanceof ShoppinglistPackageImpl ? (ShoppinglistPackageImpl)registeredShoppinglistPackage : new ShoppinglistPackageImpl();
		...
		theShoppinglistPackage.freeze();

		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(ShoppinglistPackage.eNS_URI, theShoppinglistPackage);
		return theShoppinglistPackage;
	}
	 ...
	 */
	@Override
	public EClass getShoppingList() {
		return shoppingListEClass;
	}
	 ...
	 */
	@Override
	public EAttribute getShoppingList_ShoppingListId() {
		return (EAttribute)shoppingListEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 */
	@Override
	public EAttribute getShoppingList_CarrierPartyId() {
		return (EAttribute)shoppingListEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 */
	@Override
	public EAttribute getShoppingList_CarrierRoleTypeId() {
		return (EAttribute)shoppingListEClass.getEStructuralFeatures().get(2);
	}
	 ...
	 */
	@Override
	public EAttribute getShoppingList_CurrencyUom() {
		return (EAttribute)shoppingListEClass.getEStructuralFeatures().get(4);
	}
	 ...
	 */
	@Override
	public EAttribute getShoppingList_Description() {
		return (EAttribute)shoppingListEClass.getEStructuralFeatures().get(5);
	}
	 ...
	 */
	@Override
	public EAttribute getShoppingList_IsActive() {
		return (EAttribute)shoppingListEClass.getEStructuralFeatures().get(6);
	}
	 ...
	 */
	@Override
	public EAttribute getShoppingList_IsPublic() {
		return (EAttribute)shoppingListEClass.getEStructuralFeatures().get(7);
	}
	 ...
	 */
	@Override
	public EAttribute getShoppingList_LastAdminModified() {
		return (EAttribute)shoppingListEClass.getEStructuralFeatures().get(8);
	}
	 ...
	 */
	@Override
	public EAttribute getShoppingList_LastOrderedDate() {
		return (EAttribute)shoppingListEClass.getEStructuralFeatures().get(9);
	}
	 ...
	 */
	@Override
	public EAttribute getShoppingList_ListName() {
		return (EAttribute)shoppingListEClass.getEStructuralFeatures().get(10);
	}
	 ...
	 */
	@Override
	public EAttribute getShoppingList_ShipmentMethodTypeId() {
		return (EAttribute)shoppingListEClass.getEStructuralFeatures().get(17);
	}
	 ...
	 */
	@Override
	public EAttribute getShoppingListItem_ShoppingListItemSeqId() {
		return (EAttribute)shoppingListItemEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 */
	@Override
	public EAttribute getShoppingListItem_ConfigId() {
		return (EAttribute)shoppingListItemEClass.getEStructuralFeatures().get(2);
	}
	 ...
	 */
	@Override
	public EAttribute getShoppingListItem_ModifiedPrice() {
		return (EAttribute)shoppingListItemEClass.getEStructuralFeatures().get(3);
	}
	 ...
	 */
	@Override
	public EAttribute getShoppingListItem_Quantity() {
		return (EAttribute)shoppingListItemEClass.getEStructuralFeatures().get(5);
	}
	 ...
	 */
	@Override
	public EAttribute getShoppingListItem_QuantityPurchased() {
		return (EAttribute)shoppingListItemEClass.getEStructuralFeatures().get(6);
	}
	 ...
	 */
	@Override
	public EAttribute getShoppingListItem_ReservLength() {
		return (EAttribute)shoppingListItemEClass.getEStructuralFeatures().get(7);
	}
	 ...
	 */
	@Override
	public EAttribute getShoppingListItem_ReservPersons() {
		return (EAttribute)shoppingListItemEClass.getEStructuralFeatures().get(8);
	}
	 ...
	 */
	@Override
	public EAttribute getShoppingListItem_ReservStart() {
		return (EAttribute)shoppingListItemEClass.getEStructuralFeatures().get(9);
	}
	 ...
	 */
	@Override
	public EClass getShoppingListItemSurvey() {
		return shoppingListItemSurveyEClass;
	}
	 ...
	 */
	@Override
	public EClass getShoppingListType() {
		return shoppingListTypeEClass;
	}
	 ...
	 */
	@Override
	public EAttribute getShoppingListType_ShoppingListTypeId() {
		return (EAttribute)shoppingListTypeEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 */
	@Override
	public EAttribute getShoppingListType_Description() {
		return (EAttribute)shoppingListTypeEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 */
	@Override
	public ShoppinglistFactory getShoppinglistFactory() {
		return (ShoppinglistFactory)getEFactoryInstance();
	}
	...
	public void createPackageContents() {
		...
		shoppingListEClass = createEClass(SHOPPING_LIST);
		...
		createEAttribute(shoppingListEClass, SHOPPING_LIST__IS_PUBLIC);
		...
		createEAttribute(shoppingListItemEClass, SHOPPING_LIST_ITEM__RESERV_PERSONS);
	...
	public void initializePackageContents() {
		...
		initEAttribute(getShoppingListItem_ReservPersons(), ecorePackage.getEBigDecimal(), "reservPersons", null, 0, 1, ShoppingListItem.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
	...
	protected void createMimoentframeAnnotations() {
		...
		addAnnotation
		  (shoppingListItemSurveyEClass,
		   source,
		   new String[] {
			   "title", "Shopping List Item"
		   });
		addAnnotation
		  (shoppingListTypeEClass,
		   source,
		   new String[] {
	...
	protected void createMimoentformatAnnotations() {
		...
		addAnnotation
		  (getShoppingListItem_ModifiedPrice(),
		   source,
		   new String[] {
		...
		addAnnotation
		  (getShoppingListItem_QuantityPurchased(),
		   source,
		   new String[] {
			   "type", "fixed-point",
			   "precision", "18",
		...
		addAnnotation
		  (getShoppingListItem_ReservLength(),
		   source,
		   new String[] {
			   "type", "fixed-point",
			   "precision", "18",
		...
		addAnnotation
		  (getShoppingListItem_ReservPersons(),
		   source,
		   new String[] {
			   "type", "fixed-point",
			   "precision", "18",
