...
public class OrderPackageImpl extends EPackageImpl implements OrderPackage {
	...
	public void initializePackageContents() {
		...
		orderBlacklistEClass.getESuperTypes().add(theEntityPackage_1.getEntityIdentifiable());
		orderBlacklistEClass.getESuperTypes().add(theEntityPackage_1.getEntityInfo());
		orderBlacklistTypeEClass.getESuperTypes().add(theEntityPackage_1.getEntityIdentifiable());
		orderBlacklistTypeEClass.getESuperTypes().add(theEntityPackage_1.getEntityInfo());
		...
		initEAttribute(getOrderHeader_Priority(), ecorePackage.getEChar(), "priority", null, 1, 1, OrderHeader.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
