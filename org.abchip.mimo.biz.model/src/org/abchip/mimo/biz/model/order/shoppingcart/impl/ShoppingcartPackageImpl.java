...
import org.abchip.mimo.biz.model.order.shoppingcart.ShoppingcartFactory;
 ...
 * @generated
 */
public class ShoppingcartPackageImpl extends EPackageImpl implements ShoppingcartPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private EClass cartAbandonedLineEClass = null;
	 ...
	 * @see org.abchip.mimo.biz.model.order.shoppingcart.ShoppingcartPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private ShoppingcartPackageImpl() {
		super(eNS_URI, ShoppingcartFactory.eINSTANCE);
	}
	 ...
	 *
	 * <p>This method is used to initialize {@link ShoppingcartPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static ShoppingcartPackage init() {
		if (isInited) return (ShoppingcartPackage)EPackage.Registry.INSTANCE.getEPackage(ShoppingcartPackage.eNS_URI);

		// Obtain or create and register package
		Object registeredShoppingcartPackage = EPackage.Registry.INSTANCE.get(eNS_URI);
		ShoppingcartPackageImpl theShoppingcartPackage = registeredShoppingcartPackage instanceof ShoppingcartPackageImpl ? (ShoppingcartPackageImpl)registeredShoppingcartPackage : new ShoppingcartPackageImpl();
		...
		theShoppingcartPackage.freeze();

		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(ShoppingcartPackage.eNS_URI, theShoppingcartPackage);
		return theShoppingcartPackage;
	}
	 ...
	 */
	@Override
	public EClass getCartAbandonedLine() {
		return cartAbandonedLineEClass;
	}
	 ...
	 */
	@Override
	public EAttribute getCartAbandonedLine_ConfigId() {
		return (EAttribute)cartAbandonedLineEClass.getEStructuralFeatures().get(2);
	}
	...
	public ShoppingcartFactory getShoppingcartFactory() {
		return (ShoppingcartFactory)getEFactoryInstance();
	}
	...
	public void createPackageContents() {
		...
		createEAttribute(cartAbandonedLineEClass, CART_ABANDONED_LINE__RESERV_NTH_PP_PERC);
		createEAttribute(cartAbandonedLineEClass, CART_ABANDONED_LINE__RESERV_PERSONS);
		createEAttribute(cartAbandonedLineEClass, CART_ABANDONED_LINE__RESERV_START);
	...
	public void initializePackageContents() {
		...
		initEAttribute(getCartAbandonedLine_ReservNthPPPerc(), ecorePackage.getEBigDecimal(), "reservNthPPPerc", null, 0, 1, CartAbandonedLine.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getCartAbandonedLine_ReservPersons(), ecorePackage.getEBigDecimal(), "reservPersons", null, 0, 1, CartAbandonedLine.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
	...
	protected void createMimoentformatAnnotations() {
		...
		addAnnotation
		  (getCartAbandonedLine_Reserv2ndPPPerc(),
		   source,
		   new String[] {
			   "type", "fixed-point",
			   "precision", "18",
		...
		addAnnotation
		  (getCartAbandonedLine_ReservLength(),
		   source,
		   new String[] {
			   "type", "fixed-point",
			   "precision", "18",
		...
		addAnnotation
		  (getCartAbandonedLine_ReservNthPPPerc(),
		   source,
		   new String[] {
			   "type", "fixed-point",
			   "precision", "18",
		...
		addAnnotation
		  (getCartAbandonedLine_ReservPersons(),
		   source,
		   new String[] {
			   "type", "fixed-point",
			   "precision", "18",
		...
		addAnnotation
		  (getCartAbandonedLine_TotalWithAdjustments(),
		   source,
		   new String[] {
		...
		addAnnotation
		  (getCartAbandonedLine_UnitPrice(),
		   source,
		   new String[] {
			   "type", "currency-amount",
			   "precision", "18",
