...
import org.abchip.mimo.biz.model.entity.crypto.CryptoFactory;
 ...
 * @generated
 */
public class CryptoPackageImpl extends EPackageImpl implements CryptoPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private EClass entityKeyStoreEClass = null;
	 ...
	 * @see org.abchip.mimo.biz.model.entity.crypto.CryptoPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private CryptoPackageImpl() {
		super(eNS_URI, CryptoFactory.eINSTANCE);
	}
	 ...
	 *
	 * <p>This method is used to initialize {@link CryptoPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static CryptoPackage init() {
		if (isInited) return (CryptoPackage)EPackage.Registry.INSTANCE.getEPackage(CryptoPackage.eNS_URI);

		// Obtain or create and register package
		Object registeredCryptoPackage = EPackage.Registry.INSTANCE.get(eNS_URI);
		CryptoPackageImpl theCryptoPackage = registeredCryptoPackage instanceof CryptoPackageImpl ? (CryptoPackageImpl)registeredCryptoPackage : new CryptoPackageImpl();
		...
		theCryptoPackage.freeze();

		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(CryptoPackage.eNS_URI, theCryptoPackage);
		return theCryptoPackage;
	}
	 ...
	 */
	@Override
	public EClass getEntityKeyStore() {
		return entityKeyStoreEClass;
	}
	 ...
	 */
	@Override
	public EAttribute getEntityKeyStore_KeyName() {
		return (EAttribute)entityKeyStoreEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 */
	@Override
	public EAttribute getEntityKeyStore_KeyText() {
		return (EAttribute)entityKeyStoreEClass.getEStructuralFeatures().get(1);
	}
	...
	public CryptoFactory getCryptoFactory() {
		return (CryptoFactory)getEFactoryInstance();
	}
	...
	public void createPackageContents() {
		...
		entityKeyStoreEClass = createEClass(ENTITY_KEY_STORE);
		createEAttribute(entityKeyStoreEClass, ENTITY_KEY_STORE__KEY_NAME);
		createEAttribute(entityKeyStoreEClass, ENTITY_KEY_STORE__KEY_TEXT);
	}
	...
	public void initializePackageContents() {
		...
		entityKeyStoreEClass.getESuperTypes().add(theEntityPackage_1.getEntityIdentifiable());
		entityKeyStoreEClass.getESuperTypes().add(theEntityPackage_1.getEntityInfo());
