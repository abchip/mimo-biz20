...
import org.abchip.mimo.biz.model.entity.tenant.TenantFactory;
import org.abchip.mimo.biz.model.entity.tenant.TenantKeyEncryptingKey;
...
public class TenantPackageImpl extends EPackageImpl implements TenantPackage {
	 ...
	 * @generated
	 */
	private EClass tenantComponentEClass = null;
	 ...
	 * @generated
	 */
	private EClass tenantDataSourceEClass = null;
	 ...
	 * @generated
	 */
	private EClass tenantDomainNameEClass = null;
	 ...
	 * @generated
	 */
	private EClass tenantKeyEncryptingKeyEClass = null;
	 ...
	 * @see org.abchip.mimo.biz.model.entity.tenant.TenantPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	 ...
	 */
	@Override
	public EAttribute getComponent_RootLocation() {
	 ...
	 */
	@Override
	public EAttribute getTenant_TenantId() {
	 ...
	 */
	@Override
	public EAttribute getTenant_Disabled() {
	 ...
	 */
	@Override
	public EAttribute getTenant_InitialPath() {
		return (EAttribute)tenantEClass.getEStructuralFeatures().get(2);
	}
	 ...
	 */
	@Override
	public EReference getTenantComponent_Tenant() {
		return (EReference)tenantComponentEClass.getEStructuralFeatures().get(0);
	}
	...
	public EAttribute getTenantComponent_SequenceNum() {
		return (EAttribute)tenantComponentEClass.getEStructuralFeatures().get(2);
	}
	 ...
	 */
	@Override
	public EClass getTenantDataSource() {
		return tenantDataSourceEClass;
	}
	 ...
	 */
	@Override
	public EReference getTenantDataSource_Tenant() {
		return (EReference)tenantDataSourceEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 */
	@Override
	public EClass getTenantDomainName() {
		return tenantDomainNameEClass;
	}
	 ...
	 */
	@Override
	public EAttribute getTenantDomainName_DomainName() {
		return (EAttribute)tenantDomainNameEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 */
	@Override
	public EReference getTenantDomainName_Tenant() {
		return (EReference)tenantDomainNameEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 */
	@Override
	public EClass getTenantKeyEncryptingKey() {
		return tenantKeyEncryptingKeyEClass;
	}
	...
	public void createPackageContents() {
		...
		createEReference(tenantComponentEClass, TENANT_COMPONENT__TENANT);
		...
		createEReference(tenantDataSourceEClass, TENANT_DATA_SOURCE__TENANT);
		...
		createEReference(tenantDomainNameEClass, TENANT_DOMAIN_NAME__TENANT);
	...
	public void initializePackageContents() {
		...
		initEReference(getTenantComponent_Tenant(), this.getTenant(), null, "tenant", null, 1, 1, TenantComponent.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		getTenantComponent_Tenant().getEKeys().add(this.getTenant_TenantId());
		initEReference(getTenantComponent_ComponentName(), this.getComponent(), null, "componentName", null, 1, 1, TenantComponent.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getTenantDataSource_Tenant(), this.getTenant(), null, "tenant", null, 1, 1, TenantDataSource.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		getTenantDataSource_Tenant().getEKeys().add(this.getTenant_TenantId());
		...
		initEReference(getTenantDomainName_Tenant(), this.getTenant(), null, "tenant", null, 0, 1, TenantDomainName.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		getTenantDomainName_Tenant().getEKeys().add(this.getTenant_TenantId());
	...
	protected void createMimoentframeAnnotations() {
		...
		addAnnotation
		  (componentEClass,
		   source,
		   new String[] {
			   "help", "Component Entity"
		   });
		addAnnotation
		  (tenantDataSourceEClass,
		   source,
		   new String[] {
			   "help", "There should be one record for each tenant and each group-map for the active delegator.\n            The jdbc fields will override the datasource -> inline-jdbc values for the per-tenant delegator."
		   });
		addAnnotation
		  (tenantDomainNameEClass,
		   source,
		   new String[] {
			   "title", "Tenant and its Domain Name"
		   });
		addAnnotation
		  (tenantKeyEncryptingKeyEClass,
		   source,
		   new String[] {
			   "help", "There should be one record for each tenant and each group-map for the active delegator.\n            The jdbc fields will override the datasource -> inline-jdbc values for the per-tenant delegator."
		   });
