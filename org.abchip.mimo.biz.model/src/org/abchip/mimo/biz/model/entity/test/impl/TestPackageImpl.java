...
public class TestPackageImpl extends EPackageImpl implements TestPackage {
	 ...
	 * @generated
	 */
	private EClass testFieldTypeEClass = null;
	 ...
	 * @generated
	 */
	private EClass testingCryptoEClass = null;
	 ...
	 * @generated
	 */
	private EClass testingItemEClass = null;
	 ...
	 * @generated
	 */
	private EClass testingNodeEClass = null;
	 ...
	 * @generated
	 */
	private EClass testingNodeMemberEClass = null;
	 ...
	 * @generated
	 */
	private EClass testingRemoveAllEClass = null;
	 ...
	 * @generated
	 */
	private EClass testingStatusEClass = null;
	 ...
	 * @generated
	 */
	private EClass testingSubtypeEClass = null;
	 ...
	 * @generated
	 */
	private EClass testingTypeEClass = null;
	 ...
	 * @see org.abchip.mimo.biz.model.entity.test.TestPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	 ...
	 */
	@Override
	public EClass getTestFieldType() {
		return testFieldTypeEClass;
	}
	 ...
	 */
	@Override
	public EAttribute getTestFieldType_TestFieldTypeId() {
		return (EAttribute)testFieldTypeEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 */
	@Override
	public EAttribute getTestFieldType_BlobField() {
		return (EAttribute)testFieldTypeEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 */
	@Override
	public EAttribute getTestFieldType_ByteArrayField() {
		return (EAttribute)testFieldTypeEClass.getEStructuralFeatures().get(2);
	}
	 ...
	 */
	@Override
	public EAttribute getTestFieldType_ClobField() {
		return (EAttribute)testFieldTypeEClass.getEStructuralFeatures().get(3);
	}
	 ...
	 */
	@Override
	public EAttribute getTestFieldType_DateField() {
		return (EAttribute)testFieldTypeEClass.getEStructuralFeatures().get(4);
	}
	 ...
	 */
	@Override
	public EAttribute getTestFieldType_DateTimeField() {
		return (EAttribute)testFieldTypeEClass.getEStructuralFeatures().get(5);
	}
	 ...
	 */
	@Override
	public EAttribute getTestFieldType_FixedPointField() {
		return (EAttribute)testFieldTypeEClass.getEStructuralFeatures().get(6);
	}
	 ...
	 */
	@Override
	public EAttribute getTestFieldType_FloatingPointField() {
		return (EAttribute)testFieldTypeEClass.getEStructuralFeatures().get(7);
	}
	 ...
	 */
	@Override
	public EAttribute getTestFieldType_NumericField() {
		return (EAttribute)testFieldTypeEClass.getEStructuralFeatures().get(8);
	}
	 ...
	 */
	@Override
	public EAttribute getTestFieldType_ObjectField() {
		return (EAttribute)testFieldTypeEClass.getEStructuralFeatures().get(9);
	}
	 ...
	 */
	@Override
	public EAttribute getTestFieldType_TimeField() {
		return (EAttribute)testFieldTypeEClass.getEStructuralFeatures().get(10);
	}
	 ...
	 */
	@Override
	public EAttribute getTesting_TestingId() {
	 ...
	 */
	@Override
	public EAttribute getTesting_Comments() {
	 ...
	 */
	@Override
	public EAttribute getTesting_TestingDate() {
		return (EAttribute)testingEClass.getEStructuralFeatures().get(3);
	}
	 ...
	 */
	@Override
	public EReference getTesting_TestingType() {
	 ...
	 */
	@Override
	public EClass getTestingCrypto() {
		return testingCryptoEClass;
	}
	 ...
	 */
	@Override
	public EAttribute getTestingCrypto_TestingCryptoId() {
		return (EAttribute)testingCryptoEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 */
	@Override
	public EAttribute getTestingCrypto_EncryptedValue() {
		return (EAttribute)testingCryptoEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 */
	@Override
	public EAttribute getTestingCrypto_SaltedEncryptedValue() {
		return (EAttribute)testingCryptoEClass.getEStructuralFeatures().get(2);
	}
	 ...
	 */
	@Override
	public EAttribute getTestingCrypto_TestingCryptoTypeId() {
		return (EAttribute)testingCryptoEClass.getEStructuralFeatures().get(3);
	}
	 ...
	 */
	@Override
	public EAttribute getTestingCrypto_UnencryptedValue() {
		return (EAttribute)testingCryptoEClass.getEStructuralFeatures().get(4);
	}
	 ...
	 */
	@Override
	public EClass getTestingItem() {
		return testingItemEClass;
	}
	 ...
	 */
	@Override
	public EReference getTestingItem_Testing() {
		return (EReference)testingItemEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 */
	@Override
	public EClass getTestingNode() {
		return testingNodeEClass;
	}
	 ...
	 */
	@Override
	public EAttribute getTestingNode_TestingNodeId() {
		return (EAttribute)testingNodeEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 */
	@Override
	public EAttribute getTestingNode_Description() {
		return (EAttribute)testingNodeEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 */
	@Override
	public EReference getTestingNode_PrimaryParentNode() {
	 ...
	 */
	@Override
	public EReference getTestingNodeMember_Testing() {
		return (EReference)testingNodeMemberEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 */
	@Override
	public EReference getTestingNodeMember_TestingNode() {
		return (EReference)testingNodeMemberEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 */
	@Override
	public EClass getTestingRemoveAll() {
		return testingRemoveAllEClass;
	}
	 ...
	 */
	@Override
	public EAttribute getTestingRemoveAll_TestingRemoveAllId() {
		return (EAttribute)testingRemoveAllEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 */
	@Override
	public EAttribute getTestingRemoveAll_Description() {
		return (EAttribute)testingRemoveAllEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 */
	@Override
	public EClass getTestingStatus() {
		return testingStatusEClass;
	}
	 ...
	 */
	@Override
	public EAttribute getTestingStatus_TestingStatusId() {
		return (EAttribute)testingStatusEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 */
	@Override
	public EReference getTestingStatus_ChangeByUserLogin() {
		return (EReference)testingStatusEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 */
	@Override
	public EReference getTestingStatus_Status() {
		return (EReference)testingStatusEClass.getEStructuralFeatures().get(2);
	}
	 ...
	 */
	@Override
	public EClass getTestingSubtype() {
		return testingSubtypeEClass;
	}
	 ...
	 */
	@Override
	public EAttribute getTestingSubtype_TestingTypeId() {
		return (EAttribute)testingSubtypeEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 */
	@Override
	public EAttribute getTestingSubtype_SubtypeDescription() {
		return (EAttribute)testingSubtypeEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 */
	@Override
	public EClass getTestingType() {
		return testingTypeEClass;
	}
	 ...
	 */
	@Override
	public EAttribute getTestingType_TestingTypeId() {
		return (EAttribute)testingTypeEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 */
	@Override
	public EAttribute getTestingType_Description() {
		return (EAttribute)testingTypeEClass.getEStructuralFeatures().get(1);
	}
	...
	public void createPackageContents() {
		...
		createEAttribute(testFieldTypeEClass, TEST_FIELD_TYPE__BYTE_ARRAY_FIELD);
		createEAttribute(testFieldTypeEClass, TEST_FIELD_TYPE__CLOB_FIELD);
		createEAttribute(testFieldTypeEClass, TEST_FIELD_TYPE__DATE_FIELD);
		createEAttribute(testFieldTypeEClass, TEST_FIELD_TYPE__DATE_TIME_FIELD);
		createEAttribute(testFieldTypeEClass, TEST_FIELD_TYPE__FIXED_POINT_FIELD);
		createEAttribute(testFieldTypeEClass, TEST_FIELD_TYPE__FLOATING_POINT_FIELD);
		createEAttribute(testFieldTypeEClass, TEST_FIELD_TYPE__NUMERIC_FIELD);
		createEAttribute(testFieldTypeEClass, TEST_FIELD_TYPE__OBJECT_FIELD);
		createEAttribute(testFieldTypeEClass, TEST_FIELD_TYPE__TIME_FIELD);

		testingEClass = createEClass(TESTING);
		createEAttribute(testingEClass, TESTING__TESTING_ID);
		...
		createEReference(testingEClass, TESTING__TESTING_TYPE);

		testingCryptoEClass = createEClass(TESTING_CRYPTO);
		createEAttribute(testingCryptoEClass, TESTING_CRYPTO__TESTING_CRYPTO_ID);
		createEAttribute(testingCryptoEClass, TESTING_CRYPTO__ENCRYPTED_VALUE);
		createEAttribute(testingCryptoEClass, TESTING_CRYPTO__SALTED_ENCRYPTED_VALUE);
		createEAttribute(testingCryptoEClass, TESTING_CRYPTO__TESTING_CRYPTO_TYPE_ID);
		createEAttribute(testingCryptoEClass, TESTING_CRYPTO__UNENCRYPTED_VALUE);

		testingItemEClass = createEClass(TESTING_ITEM);
		createEReference(testingItemEClass, TESTING_ITEM__TESTING);
		...
		createEReference(testingNodeEClass, TESTING_NODE__PRIMARY_PARENT_NODE);
		...
		createEReference(testingNodeMemberEClass, TESTING_NODE_MEMBER__TESTING);
		createEReference(testingNodeMemberEClass, TESTING_NODE_MEMBER__TESTING_NODE);
		...
		createEAttribute(testingRemoveAllEClass, TESTING_REMOVE_ALL__DESCRIPTION);

		testingStatusEClass = createEClass(TESTING_STATUS);
		createEAttribute(testingStatusEClass, TESTING_STATUS__TESTING_STATUS_ID);
		createEReference(testingStatusEClass, TESTING_STATUS__CHANGE_BY_USER_LOGIN);
		createEReference(testingStatusEClass, TESTING_STATUS__STATUS);
		...
		createEAttribute(testingSubtypeEClass, TESTING_SUBTYPE__SUBTYPE_DESCRIPTION);
	...
	public void initializePackageContents() {
		...
		initEAttribute(getTestFieldType_ByteArrayField(), ecorePackage.getEByteArray(), "byteArrayField", null, 0, 1, TestFieldType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getTestFieldType_ClobField(), ecorePackage.getEString(), "clobField", null, 0, 1, TestFieldType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getTestFieldType_DateField(), ecorePackage.getEDate(), "dateField", null, 0, 1, TestFieldType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getTestFieldType_DateTimeField(), ecorePackage.getEDate(), "dateTimeField", null, 0, 1, TestFieldType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getTestFieldType_FixedPointField(), ecorePackage.getEBigDecimal(), "fixedPointField", null, 0, 1, TestFieldType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getTestFieldType_FloatingPointField(), ecorePackage.getEDouble(), "floatingPointField", null, 0, 1, TestFieldType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getTestFieldType_NumericField(), ecorePackage.getELong(), "numericField", null, 0, 1, TestFieldType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getTestFieldType_ObjectField(), ecorePackage.getEJavaObject(), "objectField", null, 0, 1, TestFieldType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getTestFieldType_TimeField(), ecorePackage.getEDate(), "timeField", null, 0, 1, TestFieldType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(testingEClass, Testing.class, "Testing", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getTesting_TestingId(), ecorePackage.getEString(), "testingId", null, 1, 1, Testing.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getTesting_TestingType(), this.getTestingType(), null, "testingType", null, 0, 1, Testing.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		getTesting_TestingType().getEKeys().add(this.getTestingType_TestingTypeId());
		...
		initEAttribute(getTestingCrypto_EncryptedValue(), ecorePackage.getEString(), "encryptedValue", null, 0, 1, TestingCrypto.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getTestingCrypto_SaltedEncryptedValue(), ecorePackage.getEString(), "saltedEncryptedValue", null, 0, 1, TestingCrypto.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getTestingCrypto_TestingCryptoTypeId(), ecorePackage.getEString(), "testingCryptoTypeId", null, 0, 1, TestingCrypto.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getTestingItem_Testing(), this.getTesting(), null, "testing", null, 1, 1, TestingItem.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		getTestingItem_Testing().getEKeys().add(this.getTesting_TestingId());
		...
		initEReference(getTestingNode_PrimaryParentNode(), this.getTestingNode(), null, "primaryParentNode", null, 0, 1, TestingNode.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		getTestingNode_PrimaryParentNode().getEKeys().add(this.getTestingNode_TestingNodeId());
		...
		initEReference(getTestingNodeMember_Testing(), this.getTesting(), null, "testing", null, 1, 1, TestingNodeMember.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		getTestingNodeMember_Testing().getEKeys().add(this.getTesting_TestingId());
		initEReference(getTestingNodeMember_TestingNode(), this.getTestingNode(), null, "testingNode", null, 1, 1, TestingNodeMember.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		getTestingNodeMember_TestingNode().getEKeys().add(this.getTestingNode_TestingNodeId());
		...
		initEAttribute(getTestingRemoveAll_Description(), ecorePackage.getEString(), "description", null, 0, 1, TestingRemoveAll.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getTestingStatus_ChangeByUserLogin(), theLoginPackage.getUserLogin(), null, "changeByUserLogin", null, 0, 1, TestingStatus.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		getTestingStatus_ChangeByUserLogin().getEKeys().add(theLoginPackage.getUserLogin_UserLoginId());
		initEReference(getTestingStatus_Status(), theStatusPackage.getStatusItem(), null, "status", null, 0, 1, TestingStatus.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		getTestingStatus_Status().getEKeys().add(theStatusPackage.getStatusItem_StatusId());
		...
		initEAttribute(getTestingSubtype_SubtypeDescription(), ecorePackage.getEString(), "subtypeDescription", null, 0, 1, TestingSubtype.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(testingTypeEClass, TestingType.class, "TestingType", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
	...
	protected void createMimoentslotAnnotations() {
		...
		addAnnotation
		  (getTestingNodeMember_TestingNode(),
		   source,
		   new String[] {
			   "key", "true"
		   });
	...
	protected void createMimoentframeAnnotations() {
		...
		addAnnotation
		  (testFieldTypeEClass,
		   source,
		   new String[] {
			   "help", "An entity for testing the field data types",
		...
		addAnnotation
		  (testingStatusEClass,
		   source,
		   new String[] {
			   "help", "An entity for testing EntityStatus concept",
