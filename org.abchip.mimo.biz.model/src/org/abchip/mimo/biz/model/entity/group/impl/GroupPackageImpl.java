...
import org.abchip.mimo.biz.model.entity.group.GroupFactory;
...
public class GroupPackageImpl extends EPackageImpl implements GroupPackage {
	 ...
	 * @generated
	 */
	private EClass entityGroupEntryEClass = null;
	 ...
	 * @see org.abchip.mimo.biz.model.entity.group.GroupPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public static GroupPackage init() {
		...
		GroupPackageImpl theGroupPackage = registeredGroupPackage instanceof GroupPackageImpl ? (GroupPackageImpl)registeredGroupPackage : new GroupPackageImpl();
	 ...
	 */
	@Override
	public EAttribute getEntityGroup_EntityGroupId() {
	...
	public void initializePackageContents() {
		...
		entityGroupEClass.getESuperTypes().add(theEntityPackage_1.getEntityIdentifiable());
		entityGroupEClass.getESuperTypes().add(theEntityPackage_1.getEntityInfo());
		entityGroupEntryEClass.getESuperTypes().add(theEntityPackage_1.getEntityIdentifiable());
		entityGroupEntryEClass.getESuperTypes().add(theEntityPackage_1.getEntityInfo());
