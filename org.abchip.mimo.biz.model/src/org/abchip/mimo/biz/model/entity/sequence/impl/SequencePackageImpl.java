...
import org.abchip.mimo.biz.model.entity.sequence.SequenceFactory;
...
public class SequencePackageImpl extends EPackageImpl implements SequencePackage {
	 ...
	 * @see org.abchip.mimo.biz.model.entity.sequence.SequencePackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	 ...
	 */
	@Override
	public EAttribute getSequenceValueItem_SeqName() {
		return (EAttribute)sequenceValueItemEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 */
	@Override
	public EAttribute getSequenceValueItem_SeqId() {
		return (EAttribute)sequenceValueItemEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 */
	@Override
	public EAttribute getSequenceValueItem_SequencePolicy() {
		return (EAttribute)sequenceValueItemEClass.getEStructuralFeatures().get(2);
	}
	...
	public void createPackageContents() {
		...
		createEAttribute(sequenceValueItemEClass, SEQUENCE_VALUE_ITEM__SEQ_NAME);
		createEAttribute(sequenceValueItemEClass, SEQUENCE_VALUE_ITEM__SEQ_ID);
		createEAttribute(sequenceValueItemEClass, SEQUENCE_VALUE_ITEM__SEQUENCE_POLICY);
	}
	...
	public void initializePackageContents() {
		...
		sequenceValueItemEClass.getESuperTypes().add(theEntityPackage_1.getEntityIdentifiable());
		sequenceValueItemEClass.getESuperTypes().add(theEntityPackage_1.getEntityInfo());
		...
		initEAttribute(getSequenceValueItem_SequencePolicy(), ecorePackage.getEString(), "sequencePolicy", null, 0, 1, SequenceValueItem.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
	...
	protected void createMimoentformatAnnotations() {
		...
		addAnnotation
		  (getSequenceValueItem_SequencePolicy(),
		   source,
		   new String[] {
			   "length", "255"
		   });
