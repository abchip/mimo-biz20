...
import org.abchip.mimo.biz.model.entity.audit.AuditFactory;
...
public class AuditPackageImpl extends EPackageImpl implements AuditPackage {
	 ...
	 * @generated
	 */
	private EClass entityAuditLogEClass = null;
	 ...
	 * @see org.abchip.mimo.biz.model.entity.audit.AuditPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	 ...
	 */
	@Override
	public EClass getEntityAuditLog() {
		return entityAuditLogEClass;
	}
	 ...
	 */
	@Override
	public EAttribute getEntityAuditLog_AuditHistorySeqId() {
		return (EAttribute)entityAuditLogEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 */
	@Override
	public EAttribute getEntityAuditLog_ChangedByInfo() {
		return (EAttribute)entityAuditLogEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 */
	@Override
	public EAttribute getEntityAuditLog_ChangedDate() {
		return (EAttribute)entityAuditLogEClass.getEStructuralFeatures().get(2);
	}
	 ...
	 */
	@Override
	public EAttribute getEntityAuditLog_ChangedEntityName() {
		return (EAttribute)entityAuditLogEClass.getEStructuralFeatures().get(3);
	}
	 ...
	 */
	@Override
	public EAttribute getEntityAuditLog_ChangedFieldName() {
		return (EAttribute)entityAuditLogEClass.getEStructuralFeatures().get(4);
	}
	 ...
	 */
	@Override
	public EAttribute getEntityAuditLog_ChangedSessionInfo() {
		return (EAttribute)entityAuditLogEClass.getEStructuralFeatures().get(5);
	}
	 ...
	 */
	@Override
	public EAttribute getEntityAuditLog_NewValueText() {
		return (EAttribute)entityAuditLogEClass.getEStructuralFeatures().get(6);
	}
	 ...
	 */
	@Override
	public EAttribute getEntityAuditLog_OldValueText() {
		return (EAttribute)entityAuditLogEClass.getEStructuralFeatures().get(7);
	}
	 ...
	 */
	@Override
	public EAttribute getEntityAuditLog_PkCombinedValueText() {
		return (EAttribute)entityAuditLogEClass.getEStructuralFeatures().get(8);
	}
	...
	public void createPackageContents() {
		...
		entityAuditLogEClass = createEClass(ENTITY_AUDIT_LOG);
		createEAttribute(entityAuditLogEClass, ENTITY_AUDIT_LOG__AUDIT_HISTORY_SEQ_ID);
		createEAttribute(entityAuditLogEClass, ENTITY_AUDIT_LOG__CHANGED_BY_INFO);
		createEAttribute(entityAuditLogEClass, ENTITY_AUDIT_LOG__CHANGED_DATE);
		createEAttribute(entityAuditLogEClass, ENTITY_AUDIT_LOG__CHANGED_ENTITY_NAME);
		createEAttribute(entityAuditLogEClass, ENTITY_AUDIT_LOG__CHANGED_FIELD_NAME);
		createEAttribute(entityAuditLogEClass, ENTITY_AUDIT_LOG__CHANGED_SESSION_INFO);
		createEAttribute(entityAuditLogEClass, ENTITY_AUDIT_LOG__NEW_VALUE_TEXT);
		createEAttribute(entityAuditLogEClass, ENTITY_AUDIT_LOG__OLD_VALUE_TEXT);
		createEAttribute(entityAuditLogEClass, ENTITY_AUDIT_LOG__PK_COMBINED_VALUE_TEXT);
	}
	...
	public void initializePackageContents() {
		...
		initEAttribute(getEntityAuditLog_ChangedDate(), ecorePackage.getEDate(), "changedDate", null, 0, 1, EntityAuditLog.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getEntityAuditLog_ChangedEntityName(), ecorePackage.getEString(), "changedEntityName", null, 0, 1, EntityAuditLog.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getEntityAuditLog_ChangedFieldName(), ecorePackage.getEString(), "changedFieldName", null, 0, 1, EntityAuditLog.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getEntityAuditLog_ChangedSessionInfo(), ecorePackage.getEString(), "changedSessionInfo", null, 0, 1, EntityAuditLog.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getEntityAuditLog_NewValueText(), ecorePackage.getEString(), "newValueText", null, 0, 1, EntityAuditLog.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getEntityAuditLog_OldValueText(), ecorePackage.getEString(), "oldValueText", null, 0, 1, EntityAuditLog.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
	...
	protected void createMimoentformatAnnotations() {
		...
		addAnnotation
		  (getEntityAuditLog_ChangedEntityName(),
		   source,
		   new String[] {
			   "length", "255"
		   });
		addAnnotation
		  (getEntityAuditLog_ChangedFieldName(),
		   source,
		   new String[] {
			   "length", "255"
		   });
		...
		addAnnotation
		  (getEntityAuditLog_NewValueText(),
		   source,
		   new String[] {
			   "length", "255"
		   });
		addAnnotation
		  (getEntityAuditLog_OldValueText(),
		   source,
		   new String[] {
			   "length", "255"
		   });
		addAnnotation
		  (getEntityAuditLog_PkCombinedValueText(),
		   source,
		   new String[] {
			   "length", "255"
		   });
