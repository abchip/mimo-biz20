...
public class TaxPackageImpl extends EPackageImpl implements TaxPackage {
	...
	public void initializePackageContents() {
		...
		EGenericType g2 = createEGenericType(this.getTaxAuthorityAssocType());
		g1.getETypeArguments().add(g2);
		taxAuthorityAssocEClass.getEGenericSuperTypes().add(g1);
		g1 = createEGenericType(theEntityPackage_1.getEntityInfo());
		taxAuthorityAssocEClass.getEGenericSuperTypes().add(g1);
		g1 = createEGenericType(theEntityPackage_1.getEntityType());
		g2 = createEGenericType(this.getTaxAuthorityAssoc());
		g1.getETypeArguments().add(g2);
		taxAuthorityAssocTypeEClass.getEGenericSuperTypes().add(g1);
		g1 = createEGenericType(theEntityPackage_1.getEntityInfo());
		taxAuthorityAssocTypeEClass.getEGenericSuperTypes().add(g1);
		...
		g2 = createEGenericType(this.getTaxAuthorityRateType());
		g1.getETypeArguments().add(g2);
		taxAuthorityRateProductEClass.getEGenericSuperTypes().add(g1);
		g1 = createEGenericType(theEntityPackage_1.getEntityInfo());
		taxAuthorityRateProductEClass.getEGenericSuperTypes().add(g1);
		g1 = createEGenericType(theEntityPackage_1.getEntityType());
		g2 = createEGenericType(this.getTaxAuthorityRateProduct());
		g1.getETypeArguments().add(g2);
		taxAuthorityRateTypeEClass.getEGenericSuperTypes().add(g1);
		g1 = createEGenericType(theEntityPackage_1.getEntityInfo());
		taxAuthorityRateTypeEClass.getEGenericSuperTypes().add(g1);
