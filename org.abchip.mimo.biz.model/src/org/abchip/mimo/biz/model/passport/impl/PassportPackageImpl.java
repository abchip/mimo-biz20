...
import org.abchip.mimo.biz.model.passport.PassportFactory;
 ...
 * @generated
 */
public class PassportPackageImpl extends EPackageImpl implements PassportPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private EClass gitHubUserEClass = null;
	 ...
	 * @generated
	 */
	private EClass googleUserEClass = null;
	 ...
	 * @generated
	 */
	private EClass linkedInUserEClass = null;
	 ...
	 * @generated
	 */
	private EClass oAuth2GitHubEClass = null;
	 ...
	 * @generated
	 */
	private EClass oAuth2GoogleEClass = null;
	 ...
	 * @generated
	 */
	private EClass oAuth2LinkedInEClass = null;
	 ...
	 * @generated
	 */
	private EClass thirdPartyLoginEClass = null;
	 ...
	 * @see org.abchip.mimo.biz.model.passport.PassportPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private PassportPackageImpl() {
		super(eNS_URI, PassportFactory.eINSTANCE);
	}
	 ...
	 *
	 * <p>This method is used to initialize {@link PassportPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static PassportPackage init() {
		if (isInited) return (PassportPackage)EPackage.Registry.INSTANCE.getEPackage(PassportPackage.eNS_URI);

		// Obtain or create and register package
		Object registeredPassportPackage = EPackage.Registry.INSTANCE.get(eNS_URI);
		PassportPackageImpl thePassportPackage = registeredPassportPackage instanceof PassportPackageImpl ? (PassportPackageImpl)registeredPassportPackage : new PassportPackageImpl();
		...
		thePassportPackage.freeze();

		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(PassportPackage.eNS_URI, thePassportPackage);
		return thePassportPackage;
	}
	 ...
	 */
	@Override
	public EClass getGitHubUser() {
		return gitHubUserEClass;
	}
	 ...
	 */
	@Override
	public EAttribute getGitHubUser_GitHubUserId() {
		return (EAttribute)gitHubUserEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 */
	@Override
	public EAttribute getGitHubUser_AccessToken() {
		return (EAttribute)gitHubUserEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 */
	@Override
	public EAttribute getGitHubUser_EnvPrefix() {
		return (EAttribute)gitHubUserEClass.getEStructuralFeatures().get(2);
	}
	 ...
	 */
	@Override
	public EClass getGoogleUser() {
		return googleUserEClass;
	}
	 ...
	 */
	@Override
	public EAttribute getGoogleUser_GoogleUserId() {
		return (EAttribute)googleUserEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 */
	@Override
	public EAttribute getGoogleUser_AccessToken() {
		return (EAttribute)googleUserEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 */
	@Override
	public EAttribute getGoogleUser_EnvPrefix() {
		return (EAttribute)googleUserEClass.getEStructuralFeatures().get(2);
	}
	 ...
	 */
	@Override
	public EClass getLinkedInUser() {
		return linkedInUserEClass;
	}
	 ...
	 */
	@Override
	public EAttribute getLinkedInUser_LinkedInUserId() {
		return (EAttribute)linkedInUserEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 */
	@Override
	public EAttribute getLinkedInUser_AccessToken() {
		return (EAttribute)linkedInUserEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 */
	@Override
	public EAttribute getLinkedInUser_EnvPrefix() {
		return (EAttribute)linkedInUserEClass.getEStructuralFeatures().get(2);
	}
	 ...
	 */
	@Override
	public EClass getOAuth2GitHub() {
		return oAuth2GitHubEClass;
	}
	 ...
	 */
	@Override
	public EAttribute getOAuth2GitHub_FromDate() {
		return (EAttribute)oAuth2GitHubEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 */
	@Override
	public EAttribute getOAuth2GitHub_ClientId() {
		return (EAttribute)oAuth2GitHubEClass.getEStructuralFeatures().get(2);
	}
	 ...
	 */
	@Override
	public EAttribute getOAuth2GitHub_ClientSecret() {
		return (EAttribute)oAuth2GitHubEClass.getEStructuralFeatures().get(3);
	}
	 ...
	 */
	@Override
	public EAttribute getOAuth2GitHub_IconUrl() {
	 ...
	 */
	@Override
	public EAttribute getOAuth2GitHub_LocalRedirectUri() {
	...
	public EAttribute getOAuth2GitHub_ReturnUrl() {
		return (EAttribute)oAuth2GitHubEClass.getEStructuralFeatures().get(6);
	}
	...
	public EAttribute getOAuth2GitHub_ThruDate() {
		return (EAttribute)oAuth2GitHubEClass.getEStructuralFeatures().get(7);
	}
	 ...
	 */
	@Override
	public EClass getOAuth2Google() {
		return oAuth2GoogleEClass;
	}
	 ...
	 */
	@Override
	public EAttribute getOAuth2Google_FromDate() {
		return (EAttribute)oAuth2GoogleEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 */
	@Override
	public EAttribute getOAuth2Google_ClientId() {
		return (EAttribute)oAuth2GoogleEClass.getEStructuralFeatures().get(2);
	}
	 ...
	 */
	@Override
	public EAttribute getOAuth2Google_ClientSecret() {
		return (EAttribute)oAuth2GoogleEClass.getEStructuralFeatures().get(3);
	}
	 ...
	 */
	@Override
	public EAttribute getOAuth2Google_IconUrl() {
		return (EAttribute)oAuth2GoogleEClass.getEStructuralFeatures().get(4);
	}
	 ...
	 */
	@Override
	public EAttribute getOAuth2Google_LocalRedirectUri() {
		return (EAttribute)oAuth2GoogleEClass.getEStructuralFeatures().get(5);
	}
	 ...
	 */
	@Override
	public EAttribute getOAuth2Google_ReturnUrl() {
		return (EAttribute)oAuth2GoogleEClass.getEStructuralFeatures().get(6);
	}
	 ...
	 */
	@Override
	public EAttribute getOAuth2Google_ThruDate() {
		return (EAttribute)oAuth2GoogleEClass.getEStructuralFeatures().get(7);
	}
	 ...
	 */
	@Override
	public EClass getOAuth2LinkedIn() {
		return oAuth2LinkedInEClass;
	}
	 ...
	 */
	@Override
	public EAttribute getOAuth2LinkedIn_FromDate() {
		return (EAttribute)oAuth2LinkedInEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 */
	@Override
	public EAttribute getOAuth2LinkedIn_ApiKey() {
		return (EAttribute)oAuth2LinkedInEClass.getEStructuralFeatures().get(2);
	}
	 ...
	 */
	@Override
	public EAttribute getOAuth2LinkedIn_IconUrl() {
		return (EAttribute)oAuth2LinkedInEClass.getEStructuralFeatures().get(3);
	}
	 ...
	 */
	@Override
	public EAttribute getOAuth2LinkedIn_LiveReturnUrl() {
		return (EAttribute)oAuth2LinkedInEClass.getEStructuralFeatures().get(4);
	}
	 ...
	 */
	@Override
	public EAttribute getOAuth2LinkedIn_LocalRedirectUri() {
		return (EAttribute)oAuth2LinkedInEClass.getEStructuralFeatures().get(5);
	}
	 ...
	 */
	@Override
	public EAttribute getOAuth2LinkedIn_SecretKey() {
		return (EAttribute)oAuth2LinkedInEClass.getEStructuralFeatures().get(6);
	}
	 ...
	 */
	@Override
	public EAttribute getOAuth2LinkedIn_TestReturnUrl() {
		return (EAttribute)oAuth2LinkedInEClass.getEStructuralFeatures().get(7);
	}
	 ...
	 */
	@Override
	public EAttribute getOAuth2LinkedIn_ThruDate() {
		return (EAttribute)oAuth2LinkedInEClass.getEStructuralFeatures().get(8);
	}
	 ...
	 */
	@Override
	public EClass getThirdPartyLogin() {
		return thirdPartyLoginEClass;
	}
	 ...
	 */
	@Override
	public EAttribute getThirdPartyLogin_LoginMethTypeId() {
		return (EAttribute)thirdPartyLoginEClass.getEStructuralFeatures().get(2);
	}
	 ...
	 */
	@Override
	public EAttribute getThirdPartyLogin_LoginProviderId() {
		return (EAttribute)thirdPartyLoginEClass.getEStructuralFeatures().get(3);
	}
	 ...
	 */
	@Override
	public EAttribute getThirdPartyLogin_FromDate() {
		return (EAttribute)thirdPartyLoginEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 */
	@Override
	public EAttribute getThirdPartyLogin_SequenceNum() {
		return (EAttribute)thirdPartyLoginEClass.getEStructuralFeatures().get(4);
	}
	 ...
	 */
	@Override
	public EAttribute getThirdPartyLogin_ThruDate() {
		return (EAttribute)thirdPartyLoginEClass.getEStructuralFeatures().get(5);
	}
	 ...
	 */
	@Override
	public PassportFactory getPassportFactory() {
		return (PassportFactory)getEFactoryInstance();
	}
	...
	public void createPackageContents() {
		...
		gitHubUserEClass = createEClass(GIT_HUB_USER);
		...
		createEAttribute(oAuth2GitHubEClass, OAUTH2_GIT_HUB__ICON_URL);
		createEAttribute(oAuth2GitHubEClass, OAUTH2_GIT_HUB__LOCAL_REDIRECT_URI);
		...
		createEAttribute(oAuth2GoogleEClass, OAUTH2_GOOGLE__ICON_URL);
		createEAttribute(oAuth2GoogleEClass, OAUTH2_GOOGLE__LOCAL_REDIRECT_URI);
		createEAttribute(oAuth2GoogleEClass, OAUTH2_GOOGLE__RETURN_URL);
		...
		createEAttribute(oAuth2LinkedInEClass, OAUTH2_LINKED_IN__LIVE_RETURN_URL);
		createEAttribute(oAuth2LinkedInEClass, OAUTH2_LINKED_IN__LOCAL_REDIRECT_URI);
		createEAttribute(oAuth2LinkedInEClass, OAUTH2_LINKED_IN__SECRET_KEY);
		createEAttribute(oAuth2LinkedInEClass, OAUTH2_LINKED_IN__TEST_RETURN_URL);
		...
		createEAttribute(thirdPartyLoginEClass, THIRD_PARTY_LOGIN__SEQUENCE_NUM);
		createEAttribute(thirdPartyLoginEClass, THIRD_PARTY_LOGIN__THRU_DATE);
	}
	...
	public void initializePackageContents() {
		...
		initEAttribute(getOAuth2GitHub_IconUrl(), ecorePackage.getEString(), "iconUrl", null, 0, 1, OAuth2GitHub.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getOAuth2GitHub_LocalRedirectUri(), ecorePackage.getEString(), "localRedirectUri", null, 0, 1, OAuth2GitHub.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getOAuth2Google_IconUrl(), ecorePackage.getEString(), "iconUrl", null, 0, 1, OAuth2Google.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getOAuth2Google_LocalRedirectUri(), ecorePackage.getEString(), "localRedirectUri", null, 0, 1, OAuth2Google.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getOAuth2Google_ReturnUrl(), ecorePackage.getEString(), "returnUrl", null, 0, 1, OAuth2Google.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getOAuth2LinkedIn_LiveReturnUrl(), ecorePackage.getEString(), "liveReturnUrl", null, 0, 1, OAuth2LinkedIn.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getOAuth2LinkedIn_LocalRedirectUri(), ecorePackage.getEString(), "localRedirectUri", null, 0, 1, OAuth2LinkedIn.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getOAuth2LinkedIn_SecretKey(), ecorePackage.getEString(), "secretKey", null, 0, 1, OAuth2LinkedIn.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getOAuth2LinkedIn_TestReturnUrl(), ecorePackage.getEString(), "testReturnUrl", null, 0, 1, OAuth2LinkedIn.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getThirdPartyLogin_SequenceNum(), ecorePackage.getELong(), "sequenceNum", null, 0, 1, ThirdPartyLogin.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getThirdPartyLogin_ThruDate(), ecorePackage.getEDate(), "thruDate", null, 0, 1, ThirdPartyLogin.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
	...
	protected void createMimoentframeAnnotations() {
		...
		addAnnotation
		  (gitHubUserEClass,
		   source,
		   new String[] {
			   "help", "Data Model Enhancements For Passport",
		...
		addAnnotation
		  (oAuth2GoogleEClass,
		   ...
		   new String[] {
			   "help", "Data Model Enhancements For Passport",
			   "title", "Google OAuth Login Config"
		   });
		addAnnotation
		  (oAuth2LinkedInEClass,
		   source,
		   new String[] {
			   "help", "Data Model Enhancements For Passport",
	...
	protected void createMimoentformatAnnotations() {
		...
		addAnnotation
		  (getGitHubUser_GitHubUserId(),
		   source,
		   new String[] {
			   "length", "255"
		   });
		addAnnotation
		  (getGitHubUser_AccessToken(),
		   source,
		   new String[] {
			   "length", "255"
		   });
		addAnnotation
		  (getGitHubUser_EnvPrefix(),
		   source,
		   new String[] {
			   "length", "60"
		   });
		...
		addAnnotation
		  (getGoogleUser_GoogleUserId(),
		   source,
		   new String[] {
			   "length", "255"
		   });
		addAnnotation
		  (getGoogleUser_AccessToken(),
		   source,
		   new String[] {
			   "length", "255"
		   });
		addAnnotation
		  (getGoogleUser_EnvPrefix(),
		   source,
		   new String[] {
			   "length", "60"
		   });
		...
		addAnnotation
		  (getLinkedInUser_LinkedInUserId(),
		   source,
		   new String[] {
			   "length", "255"
		   });
		...
		addAnnotation
		  (getOAuth2GitHub_ClientId(),
		   source,
		   new String[] {
			   "length", "60"
		   });
		addAnnotation
		  (getOAuth2GitHub_ClientSecret(),
		   source,
		   new String[] {
			   "length", "60"
		   });
		...
		addAnnotation
		  (getOAuth2GitHub_ReturnUrl(),
		   source,
		   new String[] {
			   "length", "255"
		   });
		addAnnotation
		  (getOAuth2Google_ClientId(),
		   source,
		   new String[] {
			   "length", "255"
		   });
		addAnnotation
		  (getOAuth2Google_ClientSecret(),
		   source,
		   new String[] {
			   "length", "60"
		   });
		...
		addAnnotation
		  (getOAuth2Google_ReturnUrl(),
		   source,
		   new String[] {
			   "length", "255"
		   });
		addAnnotation
		  (getOAuth2LinkedIn_ApiKey(),
		   source,
		   new String[] {
			   "length", "60"
		   });
		...
		addAnnotation
		  (getOAuth2LinkedIn_LocalRedirectUri(),
		   source,
		   new String[] {
			   "length", "60"
		   });
		addAnnotation
		  (getOAuth2LinkedIn_SecretKey(),
		   source,
		   new String[] {
			   "length", "60"
		   });
		addAnnotation
		  (getOAuth2LinkedIn_TestReturnUrl(),
		   source,
		   new String[] {
			   "length", "255"
		   });
		addAnnotation
		  (getThirdPartyLogin_LoginMethTypeId(),
		   source,
		   new String[] {
			   "length", "20"
		   });
		addAnnotation
		  (getThirdPartyLogin_LoginProviderId(),
		   source,
		   new String[] {
			   "length", "20"
		   });
		addAnnotation
		  (getThirdPartyLogin_SequenceNum(),
		   source,
		   new String[] {
			   "precision", "20",
			   "scale", "0"
