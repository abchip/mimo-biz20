...
import org.abchip.mimo.biz.model.common.datasource.DatasourceFactory;
...
public class DatasourcePackageImpl extends EPackageImpl implements DatasourcePackage {
	 ...
	 * @see org.abchip.mimo.biz.model.common.datasource.DatasourcePackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public static DatasourcePackage init() {
		...
		Object registeredDatasourcePackage = EPackage.Registry.INSTANCE.get(eNS_URI);
		DatasourcePackageImpl theDatasourcePackage = registeredDatasourcePackage instanceof DatasourcePackageImpl ? (DatasourcePackageImpl)registeredDatasourcePackage : new DatasourcePackageImpl();
	 ...
	 */
	@Override
	public EAttribute getDataSourceType_DataSourceTypeId() {
		return (EAttribute)dataSourceTypeEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 */
	@Override
	public EAttribute getDataSourceType_Description() {
