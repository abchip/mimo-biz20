...
import org.abchip.mimo.biz.model.common.language.LanguageFactory;
...
public class LanguagePackageImpl extends EPackageImpl implements LanguagePackage {
	 ...
	 * @generated
	 */
	private EClass standardLanguageEClass = null;
	 ...
	 * @see org.abchip.mimo.biz.model.common.language.LanguagePackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	 ...
	 */
	@Override
	public EClass getStandardLanguage() {
		return standardLanguageEClass;
	}
	 ...
	 */
	@Override
	public EAttribute getStandardLanguage_StandardLanguageId() {
		return (EAttribute)standardLanguageEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 */
	@Override
	public EAttribute getStandardLanguage_LangCharset() {
		return (EAttribute)standardLanguageEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 */
	@Override
	public EAttribute getStandardLanguage_LangCode2() {
		return (EAttribute)standardLanguageEClass.getEStructuralFeatures().get(2);
	}
	 ...
	 */
	@Override
	public EAttribute getStandardLanguage_LangCode3b() {
		return (EAttribute)standardLanguageEClass.getEStructuralFeatures().get(3);
	}
	 ...
	 */
	@Override
	public EAttribute getStandardLanguage_LangCode3t() {
		return (EAttribute)standardLanguageEClass.getEStructuralFeatures().get(4);
	}
	 ...
	 */
	@Override
	public EAttribute getStandardLanguage_LangFamily() {
		return (EAttribute)standardLanguageEClass.getEStructuralFeatures().get(5);
	}
	 ...
	 */
	@Override
	public EAttribute getStandardLanguage_LangName() {
		return (EAttribute)standardLanguageEClass.getEStructuralFeatures().get(6);
	}
	...
	public void createPackageContents() {
		...
		standardLanguageEClass = createEClass(STANDARD_LANGUAGE);
		createEAttribute(standardLanguageEClass, STANDARD_LANGUAGE__STANDARD_LANGUAGE_ID);
		createEAttribute(standardLanguageEClass, STANDARD_LANGUAGE__LANG_CHARSET);
		createEAttribute(standardLanguageEClass, STANDARD_LANGUAGE__LANG_CODE2);
		createEAttribute(standardLanguageEClass, STANDARD_LANGUAGE__LANG_CODE3B);
		createEAttribute(standardLanguageEClass, STANDARD_LANGUAGE__LANG_CODE3T);
		createEAttribute(standardLanguageEClass, STANDARD_LANGUAGE__LANG_FAMILY);
		createEAttribute(standardLanguageEClass, STANDARD_LANGUAGE__LANG_NAME);
	}
	...
	public void initializePackageContents() {
		...
		initEAttribute(getStandardLanguage_LangCode2(), ecorePackage.getEString(), "langCode2", null, 0, 1, StandardLanguage.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getStandardLanguage_LangCode3b(), ecorePackage.getEString(), "langCode3b", null, 0, 1, StandardLanguage.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getStandardLanguage_LangCode3t(), ecorePackage.getEString(), "langCode3t", null, 0, 1, StandardLanguage.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getStandardLanguage_LangFamily(), ecorePackage.getEString(), "langFamily", null, 0, 1, StandardLanguage.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getStandardLanguage_LangName(), ecorePackage.getEString(), "langName", null, 0, 1, StandardLanguage.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
	...
	protected void createMimoentformatAnnotations() {
		...
		addAnnotation
		  (getStandardLanguage_LangCharset(),
		   source,
		   new String[] {
			   "length", "60"
		   });
		addAnnotation
		  (getStandardLanguage_LangCode2(),
		   source,
		   new String[] {
			   "length", "10"
		   });
		addAnnotation
		  (getStandardLanguage_LangCode3b(),
		   source,
		   new String[] {
			   "length", "10"
		   });
		addAnnotation
		  (getStandardLanguage_LangCode3t(),
		   source,
		   new String[] {
			   "length", "10"
		   });
		addAnnotation
		  (getStandardLanguage_LangFamily(),
		   source,
		   new String[] {
			   "length", "60"
		   });
		addAnnotation
		  (getStandardLanguage_LangName(),
		   source,
		   new String[] {
			   "length", "60"
		   });
