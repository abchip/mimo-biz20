...
import org.abchip.mimo.biz.model.common.note.NoteFactory;
 ...
 * @generated
 */
public class NotePackageImpl extends EPackageImpl implements NotePackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private EClass noteDataEClass = null;
	 ...
	 * @see org.abchip.mimo.biz.model.common.note.NotePackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private NotePackageImpl() {
		super(eNS_URI, NoteFactory.eINSTANCE);
	}
	 ...
	 *
	 * <p>This method is used to initialize {@link NotePackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static NotePackage init() {
		if (isInited) return (NotePackage)EPackage.Registry.INSTANCE.getEPackage(NotePackage.eNS_URI);

		// Obtain or create and register package
		Object registeredNotePackage = EPackage.Registry.INSTANCE.get(eNS_URI);
		NotePackageImpl theNotePackage = registeredNotePackage instanceof NotePackageImpl ? (NotePackageImpl)registeredNotePackage : new NotePackageImpl();
		...
		theNotePackage.freeze();

		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(NotePackage.eNS_URI, theNotePackage);
		return theNotePackage;
	}
	 ...
	 */
	@Override
	public EClass getNoteData() {
		return noteDataEClass;
	}
	 ...
	 */
	@Override
	public EAttribute getNoteData_NoteId() {
		return (EAttribute)noteDataEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 */
	@Override
	public EAttribute getNoteData_MoreInfoItemId() {
		return (EAttribute)noteDataEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 */
	@Override
	public EAttribute getNoteData_MoreInfoItemName() {
		return (EAttribute)noteDataEClass.getEStructuralFeatures().get(2);
	}
	 ...
	 */
	@Override
	public EAttribute getNoteData_MoreInfoUrl() {
		return (EAttribute)noteDataEClass.getEStructuralFeatures().get(3);
	}
	 ...
	 */
	@Override
	public EAttribute getNoteData_NoteDateTime() {
		return (EAttribute)noteDataEClass.getEStructuralFeatures().get(4);
	}
	 ...
	 */
	@Override
	public EAttribute getNoteData_NoteInfo() {
		return (EAttribute)noteDataEClass.getEStructuralFeatures().get(5);
	}
	 ...
	 */
	@Override
	public EAttribute getNoteData_NoteName() {
		return (EAttribute)noteDataEClass.getEStructuralFeatures().get(6);
	}
	 ...
	 */
	@Override
	public EReference getNoteData_NoteParty() {
		return (EReference)noteDataEClass.getEStructuralFeatures().get(7);
	}
	...
	public void createPackageContents() {
		...
		noteDataEClass = createEClass(NOTE_DATA);
		createEAttribute(noteDataEClass, NOTE_DATA__NOTE_ID);
		createEAttribute(noteDataEClass, NOTE_DATA__MORE_INFO_ITEM_ID);
		createEAttribute(noteDataEClass, NOTE_DATA__MORE_INFO_ITEM_NAME);
		createEAttribute(noteDataEClass, NOTE_DATA__MORE_INFO_URL);
		createEAttribute(noteDataEClass, NOTE_DATA__NOTE_DATE_TIME);
	...
	public void initializePackageContents() {
		...
		initEAttribute(getNoteData_MoreInfoItemName(), ecorePackage.getEString(), "moreInfoItemName", null, 0, 1, NoteData.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getNoteData_MoreInfoUrl(), ecorePackage.getEString(), "moreInfoUrl", null, 0, 1, NoteData.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getNoteData_NoteDateTime(), ecorePackage.getEDate(), "noteDateTime", null, 0, 1, NoteData.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
	...
	protected void createMimoentslotAnnotations() {
		...
		addAnnotation
		  (getNoteData_MoreInfoItemId(),
		   source,
		   new String[] {
			   "help", "The id of the item to be displayed i.e. custRequestId, commEventId etc"
		   });
		addAnnotation
		  (getNoteData_MoreInfoItemName(),
		   source,
		   new String[] {
			   "help", "The name of the item to be displayed i.e. custRequestId, commEventId etc"
		   });
		addAnnotation
		  (getNoteData_MoreInfoUrl(),
		   source,
		   new String[] {
			   "help", "url to go to the related screen in the system"
		   });
	}
