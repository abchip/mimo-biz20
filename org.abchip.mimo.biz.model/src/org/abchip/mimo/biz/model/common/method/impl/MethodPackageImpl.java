...
import org.abchip.mimo.biz.model.common.method.MethodFactory;
...
public class MethodPackageImpl extends EPackageImpl implements MethodPackage {
	 ...
	 * @generated
	 */
	private EClass customMethodTypeEClass = null;
	 ...
	 * @see org.abchip.mimo.biz.model.common.method.MethodPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public static MethodPackage init() {
		...
		MethodPackageImpl theMethodPackage = registeredMethodPackage instanceof MethodPackageImpl ? (MethodPackageImpl)registeredMethodPackage : new MethodPackageImpl();
	 ...
	 */
	@Override
	public EAttribute getCustomMethod_CustomMethodId() {
		return (EAttribute)customMethodEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 */
	@Override
	public EAttribute getCustomMethod_CustomMethodName() {
		return (EAttribute)customMethodEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 */
	@Override
	public EAttribute getCustomMethodType_CustomMethodTypeId() {
		return (EAttribute)customMethodTypeEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 */
	@Override
	public EAttribute getCustomMethodType_Description() {
		return (EAttribute)customMethodTypeEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 */
	@Override
	public EAttribute getCustomMethodType_HasTable() {
		return (EAttribute)customMethodTypeEClass.getEStructuralFeatures().get(2);
	}
	...
	public void initializePackageContents() {
		...
		EGenericType g2 = createEGenericType(this.getCustomMethodType());
		g1.getETypeArguments().add(g2);
		customMethodEClass.getEGenericSuperTypes().add(g1);
		g1 = createEGenericType(theEntityPackage_1.getEntityInfo());
		customMethodEClass.getEGenericSuperTypes().add(g1);
		g1 = createEGenericType(theEntityPackage_1.getEntityType());
		g2 = createEGenericType(this.getCustomMethod());
		g1.getETypeArguments().add(g2);
	...
	protected void createMimoentformatAnnotations() {
		...
		addAnnotation
		  (getCustomMethod_CustomMethodName(),
		   source,
		   new String[] {
			   "length", "255"
		   });
