...
import org.abchip.mimo.biz.model.common.keyword.KeywordFactory;
 ...
 * @generated
 */
public class KeywordPackageImpl extends EPackageImpl implements KeywordPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private EClass keywordThesaurusEClass = null;
	 ...
	 * @see org.abchip.mimo.biz.model.common.keyword.KeywordPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private KeywordPackageImpl() {
		super(eNS_URI, KeywordFactory.eINSTANCE);
	}
	 ...
	 *
	 * <p>This method is used to initialize {@link KeywordPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static KeywordPackage init() {
		if (isInited) return (KeywordPackage)EPackage.Registry.INSTANCE.getEPackage(KeywordPackage.eNS_URI);

		// Obtain or create and register package
		Object registeredKeywordPackage = EPackage.Registry.INSTANCE.get(eNS_URI);
		KeywordPackageImpl theKeywordPackage = registeredKeywordPackage instanceof KeywordPackageImpl ? (KeywordPackageImpl)registeredKeywordPackage : new KeywordPackageImpl();
		...
		theKeywordPackage.freeze();

		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(KeywordPackage.eNS_URI, theKeywordPackage);
		return theKeywordPackage;
	}
	 ...
	 */
	@Override
	public EClass getKeywordThesaurus() {
		return keywordThesaurusEClass;
	}
	 ...
	 */
	@Override
	public EReference getKeywordThesaurus_RelationshipEnum() {
		return (EReference)keywordThesaurusEClass.getEStructuralFeatures().get(2);
	}
	...
	public KeywordFactory getKeywordFactory() {
		return (KeywordFactory)getEFactoryInstance();
	}
	...
	public void createPackageContents() {
		...
		createEReference(keywordThesaurusEClass, KEYWORD_THESAURUS__RELATIONSHIP_ENUM);
	}
