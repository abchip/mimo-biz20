...
import org.abchip.mimo.biz.model.common.user.UserFactory;
...
public class UserPackageImpl extends EPackageImpl implements UserPackage {
	 ...
	 * @generated
	 */
	private EClass userPrefGroupTypeEClass = null;
	 ...
	 * @see org.abchip.mimo.biz.model.common.user.UserPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	 ...
	 */
	@Override
	public EClass getUserPrefGroupType() {
		return userPrefGroupTypeEClass;
	}
	 ...
	 */
	@Override
	public EAttribute getUserPrefGroupType_UserPrefGroupTypeId() {
		return (EAttribute)userPrefGroupTypeEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 */
	@Override
	public EAttribute getUserPrefGroupType_Description() {
		return (EAttribute)userPrefGroupTypeEClass.getEStructuralFeatures().get(1);
	}
