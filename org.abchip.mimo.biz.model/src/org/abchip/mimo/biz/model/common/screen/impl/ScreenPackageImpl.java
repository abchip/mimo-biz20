...
import org.abchip.mimo.biz.model.common.screen.ScreenFactory;
 ...
 * @generated
 */
public class ScreenPackageImpl extends EPackageImpl implements ScreenPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private EClass customScreenEClass = null;
	 ...
	 * @generated
	 */
	private EClass customScreenTypeEClass = null;
	 ...
	 * @see org.abchip.mimo.biz.model.common.screen.ScreenPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private ScreenPackageImpl() {
		super(eNS_URI, ScreenFactory.eINSTANCE);
	}
	 ...
	 *
	 * <p>This method is used to initialize {@link ScreenPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static ScreenPackage init() {
		if (isInited) return (ScreenPackage)EPackage.Registry.INSTANCE.getEPackage(ScreenPackage.eNS_URI);

		// Obtain or create and register package
		Object registeredScreenPackage = EPackage.Registry.INSTANCE.get(eNS_URI);
		ScreenPackageImpl theScreenPackage = registeredScreenPackage instanceof ScreenPackageImpl ? (ScreenPackageImpl)registeredScreenPackage : new ScreenPackageImpl();
		...
		theScreenPackage.freeze();

		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(ScreenPackage.eNS_URI, theScreenPackage);
		return theScreenPackage;
	}
	 ...
	 */
	@Override
	public EClass getCustomScreen() {
		return customScreenEClass;
	}
	 ...
	 */
	@Override
	public EAttribute getCustomScreen_CustomScreenId() {
		return (EAttribute)customScreenEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 */
	@Override
	public EAttribute getCustomScreen_CustomScreenLocation() {
		return (EAttribute)customScreenEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 */
	@Override
	public EAttribute getCustomScreen_CustomScreenName() {
		return (EAttribute)customScreenEClass.getEStructuralFeatures().get(2);
	}
	 ...
	 */
	@Override
	public EReference getCustomScreen_CustomScreenTypeId() {
		return (EReference)customScreenEClass.getEStructuralFeatures().get(3);
	}
	 ...
	 */
	@Override
	public EAttribute getCustomScreen_Description() {
		return (EAttribute)customScreenEClass.getEStructuralFeatures().get(4);
	}
	 ...
	 */
	@Override
	public EClass getCustomScreenType() {
		return customScreenTypeEClass;
	}
	 ...
	 */
	@Override
	public EAttribute getCustomScreenType_CustomScreenTypeId() {
		return (EAttribute)customScreenTypeEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 */
	@Override
	public EAttribute getCustomScreenType_Description() {
		return (EAttribute)customScreenTypeEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 */
	@Override
	public EAttribute getCustomScreenType_HasTable() {
		return (EAttribute)customScreenTypeEClass.getEStructuralFeatures().get(2);
	}
	 ...
	 */
	@Override
	public EAttribute getCustomScreenType_ParentTypeId() {
		return (EAttribute)customScreenTypeEClass.getEStructuralFeatures().get(3);
	}
	...
	public void createPackageContents() {
		...
		customScreenEClass = createEClass(CUSTOM_SCREEN);
		createEAttribute(customScreenEClass, CUSTOM_SCREEN__CUSTOM_SCREEN_ID);
		createEAttribute(customScreenEClass, CUSTOM_SCREEN__CUSTOM_SCREEN_LOCATION);
		createEAttribute(customScreenEClass, CUSTOM_SCREEN__CUSTOM_SCREEN_NAME);
		createEReference(customScreenEClass, CUSTOM_SCREEN__CUSTOM_SCREEN_TYPE_ID);
		createEAttribute(customScreenEClass, CUSTOM_SCREEN__DESCRIPTION);

		customScreenTypeEClass = createEClass(CUSTOM_SCREEN_TYPE);
		createEAttribute(customScreenTypeEClass, CUSTOM_SCREEN_TYPE__CUSTOM_SCREEN_TYPE_ID);
	...
	public void initializePackageContents() {
		...
		EGenericType g2 = createEGenericType(this.getCustomScreenType());
		g1.getETypeArguments().add(g2);
		customScreenEClass.getEGenericSuperTypes().add(g1);
		g1 = createEGenericType(theBizPackage.getBizEntityType());
		g2 = createEGenericType(this.getCustomScreen());
		g1.getETypeArguments().add(g2);
		...
		initEAttribute(getCustomScreen_CustomScreenName(), ecorePackage.getEString(), "customScreenName", null, 0, 1, CustomScreen.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getCustomScreen_CustomScreenTypeId(), this.getCustomScreenType(), null, "customScreenTypeId", null, 0, 1, CustomScreen.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		getCustomScreen_CustomScreenTypeId().getEKeys().add(this.getCustomScreenType_CustomScreenTypeId());
		initEAttribute(getCustomScreen_Description(), ecorePackage.getEString(), "description", null, 0, 1, CustomScreen.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
	...
	protected void createMimoentformatAnnotations() {
		...
		addAnnotation
		  (getCustomScreen_CustomScreenId(),
		   source,
		   new String[] {
			   "length", "20"
		   });
		addAnnotation
		  (getCustomScreen_CustomScreenLocation(),
		   source,
		   new String[] {
			   "length", "255"
		   });
		addAnnotation
		  (getCustomScreen_CustomScreenName(),
		   source,
		   new String[] {
			   "length", "255"
		   });
