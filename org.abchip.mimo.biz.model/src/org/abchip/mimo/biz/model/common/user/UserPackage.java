...
public interface UserPackage extends EPackage {
	 ...
	 * @ordered
	 */
	int USER_PREFERENCE__USER_LOGIN = EntityPackage.ENTITY_IDENTIFIABLE_FEATURE_COUNT + 4;
	 ...
	 * @ordered
	 */
	int USER_PREFERENCE__USER_PREF_GROUP_TYPE = EntityPackage.ENTITY_IDENTIFIABLE_FEATURE_COUNT + 7;
