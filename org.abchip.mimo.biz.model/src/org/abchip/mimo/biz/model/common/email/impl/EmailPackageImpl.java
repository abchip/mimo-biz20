...
import org.abchip.mimo.biz.model.common.email.EmailFactory;
...
public class EmailPackageImpl extends EPackageImpl implements EmailPackage {
	 ...
	 * @generated
	 */
	private EClass emailTemplateSettingEClass = null;
	 ...
	 * @see org.abchip.mimo.biz.model.common.email.EmailPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public static EmailPackage init() {
		...
		Object registeredEmailPackage = EPackage.Registry.INSTANCE.get(eNS_URI);
		EmailPackageImpl theEmailPackage = registeredEmailPackage instanceof EmailPackageImpl ? (EmailPackageImpl)registeredEmailPackage : new EmailPackageImpl();
	 ...
	 */
	@Override
	public EClass getEmailTemplateSetting() {
		return emailTemplateSettingEClass;
	}
	 ...
	 */
	@Override
	public EAttribute getEmailTemplateSetting_EmailTemplateSettingId() {
		return (EAttribute)emailTemplateSettingEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 */
	@Override
	public EAttribute getEmailTemplateSetting_BccAddress() {
		return (EAttribute)emailTemplateSettingEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 */
	@Override
	public EAttribute getEmailTemplateSetting_BodyScreenLocation() {
		return (EAttribute)emailTemplateSettingEClass.getEStructuralFeatures().get(2);
	}
	 ...
	 */
	@Override
	public EAttribute getEmailTemplateSetting_CcAddress() {
		return (EAttribute)emailTemplateSettingEClass.getEStructuralFeatures().get(3);
	}
	 ...
	 */
	@Override
	public EAttribute getEmailTemplateSetting_ContentType() {
		return (EAttribute)emailTemplateSettingEClass.getEStructuralFeatures().get(4);
	}
	 ...
	 */
	@Override
	public EAttribute getEmailTemplateSetting_Description() {
		return (EAttribute)emailTemplateSettingEClass.getEStructuralFeatures().get(5);
	}
	...
	public void createPackageContents() {
		...
		emailTemplateSettingEClass = createEClass(EMAIL_TEMPLATE_SETTING);
		createEAttribute(emailTemplateSettingEClass, EMAIL_TEMPLATE_SETTING__EMAIL_TEMPLATE_SETTING_ID);
		createEAttribute(emailTemplateSettingEClass, EMAIL_TEMPLATE_SETTING__BCC_ADDRESS);
		createEAttribute(emailTemplateSettingEClass, EMAIL_TEMPLATE_SETTING__BODY_SCREEN_LOCATION);
	...
	public void initializePackageContents() {
		...
		initEAttribute(getEmailTemplateSetting_BodyScreenLocation(), ecorePackage.getEString(), "bodyScreenLocation", null, 0, 1, EmailTemplateSetting.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
