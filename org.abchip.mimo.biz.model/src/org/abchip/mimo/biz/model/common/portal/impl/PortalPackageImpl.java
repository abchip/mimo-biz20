...
import org.abchip.mimo.biz.model.common.portal.PortalFactory;
...
public class PortalPackageImpl extends EPackageImpl implements PortalPackage {
	 ...
	 * @generated
	 */
	private EClass portalPageEClass = null;
	 ...
	 * @generated
	 */
	private EClass portalPageColumnEClass = null;
	 ...
	 * @generated
	 */
	private EClass portalPagePortletEClass = null;
	 ...
	 * @generated
	 */
	private EClass portalPortletEClass = null;
	 ...
	 * @generated
	 */
	private EClass portletCategoryEClass = null;
	 ...
	 * @generated
	 */
	private EClass portletPortletCategoryEClass = null;
	 ...
	 * @see org.abchip.mimo.biz.model.common.portal.PortalPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public static PortalPackage init() {
		...
		Object registeredPortalPackage = EPackage.Registry.INSTANCE.get(eNS_URI);
		PortalPackageImpl thePortalPackage = registeredPortalPackage instanceof PortalPackageImpl ? (PortalPackageImpl)registeredPortalPackage : new PortalPackageImpl();
	 ...
	 */
	@Override
	public EClass getPortalPage() {
		return portalPageEClass;
	}
	 ...
	 */
	@Override
	public EAttribute getPortalPage_PortalPageId() {
		return (EAttribute)portalPageEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 */
	@Override
	public EAttribute getPortalPage_Description() {
		return (EAttribute)portalPageEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 */
	@Override
	public EReference getPortalPage_HelpContent() {
		return (EReference)portalPageEClass.getEStructuralFeatures().get(2);
	}
	 ...
	 */
	@Override
	public EReference getPortalPage_ParentPortalPage() {
		return (EReference)portalPageEClass.getEStructuralFeatures().get(5);
	}
	 ...
	 */
	@Override
	public EReference getPortalPage_PortalPageColumns() {
	 ...
	 */
	@Override
	public EReference getPortalPage_SecurityGroup() {
	...
	public EAttribute getPortalPage_SequenceNum() {
		return (EAttribute)portalPageEClass.getEStructuralFeatures().get(9);
	}
	 ...
	 */
	@Override
	public EReference getPortalPageColumn_PortalPage() {
		return (EReference)portalPageColumnEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 */
	@Override
	public EClass getPortalPagePortlet() {
		return portalPagePortletEClass;
	}
	 ...
	 */
	@Override
	public EReference getPortalPagePortlet_PortalPage() {
		return (EReference)portalPagePortletEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 */
	@Override
	public EReference getPortalPagePortlet_PortalPortlet() {
		return (EReference)portalPagePortletEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 */
	@Override
	public EClass getPortalPortlet() {
		return portalPortletEClass;
	}
	 ...
	 */
	@Override
	public EAttribute getPortalPortlet_PortalPortletId() {
		return (EAttribute)portalPortletEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 */
	@Override
	public EAttribute getPortalPortlet_Description() {
		return (EAttribute)portalPortletEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 */
	@Override
	public EAttribute getPortalPortlet_EditFormLocation() {
		return (EAttribute)portalPortletEClass.getEStructuralFeatures().get(2);
	}
	 ...
	 */
	@Override
	public EAttribute getPortalPortlet_EditFormName() {
		return (EAttribute)portalPortletEClass.getEStructuralFeatures().get(3);
	}
	 ...
	 */
	@Override
	public EAttribute getPortalPortlet_PortletName() {
		return (EAttribute)portalPortletEClass.getEStructuralFeatures().get(4);
	}
	 ...
	 */
	@Override
	public EReference getPortalPortlet_PortletPortletCategories() {
		return (EReference)portalPortletEClass.getEStructuralFeatures().get(5);
	}
	 ...
	 */
	@Override
	public EAttribute getPortalPortlet_ScreenLocation() {
		return (EAttribute)portalPortletEClass.getEStructuralFeatures().get(6);
	}
	 ...
	 */
	@Override
	public EAttribute getPortalPortlet_ScreenName() {
		return (EAttribute)portalPortletEClass.getEStructuralFeatures().get(7);
	}
	 ...
	 */
	@Override
	public EAttribute getPortalPortlet_Screenshot() {
		return (EAttribute)portalPortletEClass.getEStructuralFeatures().get(8);
	}
	 ...
	 */
	@Override
	public EAttribute getPortalPortlet_SecurityMainAction() {
		return (EAttribute)portalPortletEClass.getEStructuralFeatures().get(9);
	}
	 ...
	 */
	@Override
	public EAttribute getPortalPortlet_SecurityServiceName() {
		return (EAttribute)portalPortletEClass.getEStructuralFeatures().get(10);
	}
	 ...
	 */
	@Override
	public EReference getPortletAttribute_PortalPortlet() {
		return (EReference)portletAttributeEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 */
	@Override
	public EAttribute getPortletAttribute_PortalPageId() {
	 ...
	 */
	@Override
	public EClass getPortletCategory() {
		return portletCategoryEClass;
	}
	 ...
	 */
	@Override
	public EAttribute getPortletCategory_PortletCategoryId() {
		return (EAttribute)portletCategoryEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 */
	@Override
	public EAttribute getPortletCategory_Description() {
		return (EAttribute)portletCategoryEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 */
	@Override
	public EReference getPortletPortletCategory_PortalPortlet() {
	 ...
	 */
	@Override
	public EReference getPortletPortletCategory_PortletCategory() {
	...
	public void createPackageContents() {
		...
		createEReference(portalPageEClass, PORTAL_PAGE__HELP_CONTENT);
		...
		createEReference(portalPageEClass, PORTAL_PAGE__PARENT_PORTAL_PAGE);
		createEReference(portalPageEClass, PORTAL_PAGE__PORTAL_PAGE_COLUMNS);
		createEAttribute(portalPageEClass, PORTAL_PAGE__PORTAL_PAGE_NAME);
		createEReference(portalPageEClass, PORTAL_PAGE__SECURITY_GROUP);
		createEAttribute(portalPageEClass, PORTAL_PAGE__SEQUENCE_NUM);

		portalPageColumnEClass = createEClass(PORTAL_PAGE_COLUMN);
		createEReference(portalPageColumnEClass, PORTAL_PAGE_COLUMN__PORTAL_PAGE);
		...
		createEReference(portalPagePortletEClass, PORTAL_PAGE_PORTLET__PORTAL_PAGE);
		createEReference(portalPagePortletEClass, PORTAL_PAGE_PORTLET__PORTAL_PORTLET);
		...
		createEAttribute(portalPortletEClass, PORTAL_PORTLET__DESCRIPTION);
		createEAttribute(portalPortletEClass, PORTAL_PORTLET__EDIT_FORM_LOCATION);
		createEAttribute(portalPortletEClass, PORTAL_PORTLET__EDIT_FORM_NAME);
		createEAttribute(portalPortletEClass, PORTAL_PORTLET__PORTLET_NAME);
		createEReference(portalPortletEClass, PORTAL_PORTLET__PORTLET_PORTLET_CATEGORIES);
		createEAttribute(portalPortletEClass, PORTAL_PORTLET__SCREEN_LOCATION);
		createEAttribute(portalPortletEClass, PORTAL_PORTLET__SCREEN_NAME);
		createEAttribute(portalPortletEClass, PORTAL_PORTLET__SCREENSHOT);
		createEAttribute(portalPortletEClass, PORTAL_PORTLET__SECURITY_MAIN_ACTION);
		createEAttribute(portalPortletEClass, PORTAL_PORTLET__SECURITY_SERVICE_NAME);

		portletAttributeEClass = createEClass(PORTLET_ATTRIBUTE);
		createEReference(portletAttributeEClass, PORTLET_ATTRIBUTE__PORTAL_PORTLET);
		...
		createEReference(portletPortletCategoryEClass, PORTLET_PORTLET_CATEGORY__PORTAL_PORTLET);
		createEReference(portletPortletCategoryEClass, PORTLET_PORTLET_CATEGORY__PORTLET_CATEGORY);
	}
	...
	public void initializePackageContents() {
		...
		initEReference(getPortalPage_HelpContent(), theContentPackage.getContent(), null, "helpContent", null, 0, 1, PortalPage.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		getPortalPage_HelpContent().getEKeys().add(theContentPackage.getContent_ContentId());
		...
		initEReference(getPortalPage_ParentPortalPage(), this.getPortalPage(), null, "parentPortalPage", null, 0, 1, PortalPage.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		getPortalPage_ParentPortalPage().getEKeys().add(this.getPortalPage_PortalPageId());
		initEReference(getPortalPage_PortalPageColumns(), this.getPortalPageColumn(), null, "portalPageColumns", null, 0, -1, PortalPage.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED, IS_ORDERED);
		...
		initEReference(getPortalPage_SecurityGroup(), theSecuritygroupPackage.getSecurityGroup(), null, "securityGroup", null, 0, 1, PortalPage.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		getPortalPage_SecurityGroup().getEKeys().add(theSecuritygroupPackage.getSecurityGroup_GroupId());
		...
		initEReference(getPortalPageColumn_PortalPage(), this.getPortalPage(), null, "portalPage", null, 1, 1, PortalPageColumn.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		getPortalPageColumn_PortalPage().getEKeys().add(this.getPortalPage_PortalPageId());
		...
		initEReference(getPortalPagePortlet_PortalPage(), this.getPortalPage(), null, "portalPage", null, 1, 1, PortalPagePortlet.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		getPortalPagePortlet_PortalPage().getEKeys().add(this.getPortalPage_PortalPageId());
		initEReference(getPortalPagePortlet_PortalPortlet(), this.getPortalPortlet(), null, "portalPortlet", null, 1, 1, PortalPagePortlet.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		getPortalPagePortlet_PortalPortlet().getEKeys().add(this.getPortalPortlet_PortalPortletId());
		...
		initEAttribute(getPortalPortlet_Description(), ecorePackage.getEString(), "description", null, 0, 1, PortalPortlet.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getPortalPortlet_EditFormLocation(), ecorePackage.getEString(), "editFormLocation", null, 0, 1, PortalPortlet.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getPortalPortlet_EditFormName(), ecorePackage.getEString(), "editFormName", null, 0, 1, PortalPortlet.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getPortalPortlet_PortletName(), ecorePackage.getEString(), "portletName", null, 0, 1, PortalPortlet.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getPortalPortlet_PortletPortletCategories(), this.getPortletPortletCategory(), null, "portletPortletCategories", null, 0, -1, PortalPortlet.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED, IS_ORDERED);
		initEAttribute(getPortalPortlet_ScreenLocation(), ecorePackage.getEString(), "screenLocation", null, 0, 1, PortalPortlet.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getPortalPortlet_ScreenName(), ecorePackage.getEString(), "screenName", null, 0, 1, PortalPortlet.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getPortalPortlet_Screenshot(), ecorePackage.getEString(), "screenshot", null, 0, 1, PortalPortlet.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getPortalPortlet_SecurityMainAction(), ecorePackage.getEString(), "securityMainAction", null, 0, 1, PortalPortlet.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getPortalPortlet_SecurityServiceName(), ecorePackage.getEString(), "securityServiceName", null, 0, 1, PortalPortlet.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getPortletAttribute_PortalPortlet(), this.getPortalPortlet(), null, "portalPortlet", null, 1, 1, PortletAttribute.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		getPortletAttribute_PortalPortlet().getEKeys().add(this.getPortalPortlet_PortalPortletId());
		...
		initEReference(getPortletPortletCategory_PortalPortlet(), this.getPortalPortlet(), null, "portalPortlet", null, 1, 1, PortletPortletCategory.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		getPortletPortletCategory_PortalPortlet().getEKeys().add(this.getPortalPortlet_PortalPortletId());
		initEReference(getPortletPortletCategory_PortletCategory(), this.getPortletCategory(), null, "portletCategory", null, 1, 1, PortletPortletCategory.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		getPortletPortletCategory_PortletCategory().getEKeys().add(this.getPortletCategory_PortletCategoryId());
	...
	protected void createMimoentframeAnnotations() {
		...
		addAnnotation
		  (portalPageEClass,
		   source,
		   new String[] {
			   "dictionary", "CommonPortalEntityLabels",
			   "formula", "description"
		   });
		addAnnotation
		  (portalPageColumnEClass,
		   source,
		   new String[] {
			   "title", "Defines a Portal Page"
		   });
		addAnnotation
		  (portalPagePortletEClass,
		   source,
		   new String[] {
	...
	protected void createMimoentformatAnnotations() {
		...
		addAnnotation
		  (getPortalPage_OwnerUserLoginId(),
		   source,
		   new String[] {
			   "length", "255"
		   });
		...
		addAnnotation
		  (getPortalPageColumn_ColumnWidthPercentage(),
		   source,
		   new String[] {
			   "precision", "20",
			   "scale", "0"
		...
		addAnnotation
		  (getPortalPageColumn_ColumnWidthPixels(),
		   source,
		   new String[] {
			   "precision", "20",
			   "scale", "0"
		...
		addAnnotation
		  (getPortalPagePortlet_ColumnSeqId(),
		   source,
		   new String[] {
			   "length", "20"
		   });
		addAnnotation
		  (getPortalPagePortlet_SequenceNum(),
		   source,
		   new String[] {
			   "precision", "20",
			   "scale", "0"
		...
		addAnnotation
		  (getPortalPortlet_PortalPortletId(),
		   source,
		   new String[] {
			   "length", "20"
		   });
		...
		addAnnotation
		  (getPortalPortlet_SecurityServiceName(),
		   source,
		   new String[] {
			   "length", "255"
		   });
		...
		addAnnotation
		  (getPortletAttribute_PortletSeqId(),
		   source,
		   new String[] {
			   "length", "20"
		   });
	...
	protected void createMimoentslotAnnotations() {
		...
		addAnnotation
		  (getPortalPage_HelpContent(),
		   source,
		   new String[] {
			   "help", "Used to give contentId which will be shown when help on this page will be called"
		   });
		addAnnotation
		  (getPortalPage_OriginalPortalPageId(),
		   source,
		   new String[] {
			   "help", "The system portal page this page is derived from"
		   });
		addAnnotation
		  (getPortalPage_ParentPortalPage(),
		   source,
		   new String[] {
			   "help", "the parent this page is belonging to, normally the startpage of the portal page group"
		   });
		addAnnotation
		  (getPortalPageColumn_PortalPage(),
		   source,
		   new String[] {
			   "key", "true"
		   });
		...
		addAnnotation
		  (getPortalPagePortlet_PortalPage(),
		   source,
		   new String[] {
			   "key", "true"
		   });
		addAnnotation
		  (getPortalPagePortlet_PortalPortlet(),
		   source,
		   new String[] {
			   "key", "true"
		   });
		addAnnotation
		  (getPortalPagePortlet_PortletSeqId(),
		   ...
		   new String[] {
			   "key", "true",
			   "help", "Identify the portalPortlet instance in case more copy of the same portalPortlet are present in the same portalPage"
		   });
		addAnnotation
		  (getPortalPortlet_SecurityMainAction(),
		   source,
		   new String[] {
			   "help", "The main action which can be done with this portlet, possible values: CREATE UPDATE VIEW DELETE"
		   });
		addAnnotation
		  (getPortalPortlet_SecurityServiceName(),
		   source,
		   new String[] {
			   "help", "The service named here is used to see if current user can see the portlet on the list of available portlets; the screen that the portlet calls should also call this service to check permission and not render; the service named here must implement the \"permissionInterface\" service just like services used for service permissions"
		   });
		addAnnotation
		  (getPortletAttribute_PortalPortlet(),
		   source,
		   new String[] {
			   "key", "true"
		   });
		...
		addAnnotation
		  (getPortletPortletCategory_PortalPortlet(),
		   source,
		   new String[] {
			   "key", "true"
		   });
		addAnnotation
		  (getPortletPortletCategory_PortletCategory(),
		   source,
		   new String[] {
			   "key", "true"
		   });
