...
import org.abchip.mimo.biz.model.content.preference.PreferenceFactory;
 ...
 * @generated
 */
public class PreferencePackageImpl extends EPackageImpl implements PreferencePackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private EClass webPreferenceTypeEClass = null;
	 ...
	 * @generated
	 */
	private EClass webUserPreferenceEClass = null;
	 ...
	 * @see org.abchip.mimo.biz.model.content.preference.PreferencePackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private PreferencePackageImpl() {
		super(eNS_URI, PreferenceFactory.eINSTANCE);
	}
	 ...
	 *
	 * <p>This method is used to initialize {@link PreferencePackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static PreferencePackage init() {
		if (isInited) return (PreferencePackage)EPackage.Registry.INSTANCE.getEPackage(PreferencePackage.eNS_URI);

		// Obtain or create and register package
		Object registeredPreferencePackage = EPackage.Registry.INSTANCE.get(eNS_URI);
		PreferencePackageImpl thePreferencePackage = registeredPreferencePackage instanceof PreferencePackageImpl ? (PreferencePackageImpl)registeredPreferencePackage : new PreferencePackageImpl();
		...
		thePreferencePackage.freeze();

		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(PreferencePackage.eNS_URI, thePreferencePackage);
		return thePreferencePackage;
	}
	 ...
	 */
	@Override
	public EClass getWebPreferenceType() {
		return webPreferenceTypeEClass;
	}
	 ...
	 */
	@Override
	public EAttribute getWebPreferenceType_WebPreferenceTypeId() {
		return (EAttribute)webPreferenceTypeEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 */
	@Override
	public EAttribute getWebPreferenceType_Description() {
		return (EAttribute)webPreferenceTypeEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 */
	@Override
	public EClass getWebUserPreference() {
		return webUserPreferenceEClass;
	}
	...
	public PreferenceFactory getPreferenceFactory() {
		return (PreferenceFactory)getEFactoryInstance();
	}
	...
	public void createPackageContents() {
		...
		webPreferenceTypeEClass = createEClass(WEB_PREFERENCE_TYPE);
		createEAttribute(webPreferenceTypeEClass, WEB_PREFERENCE_TYPE__WEB_PREFERENCE_TYPE_ID);
	...
	protected void createMimoentformatAnnotations() {
		...
		addAnnotation
		  (getWebPreferenceType_Description(),
		   source,
		   new String[] {
			   "type", "description"
		   });
		...
		addAnnotation
		  (getWebUserPreference_WebPreferenceValue(),
		   source,
		   new String[] {
			   "length", "255"
		   });
