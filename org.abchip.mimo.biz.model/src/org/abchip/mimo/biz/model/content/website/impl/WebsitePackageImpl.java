...
import org.abchip.mimo.biz.model.content.website.WebsiteFactory;
...
public class WebsitePackageImpl extends EPackageImpl implements WebsitePackage {
	 ...
	 * @generated
	 */
	private EClass webAnalyticsConfigEClass = null;
	 ...
	 * @generated
	 */
	private EClass webAnalyticsTypeEClass = null;
	 ...
	 * @generated
	 */
	private EClass webSiteContentEClass = null;
	 ...
	 * @generated
	 */
	private EClass webSiteContentTypeEClass = null;
	 ...
	 * @generated
	 */
	private EClass webSitePathAliasEClass = null;
	 ...
	 * @generated
	 */
	private EClass webSitePublishPointEClass = null;
	 ...
	 * @see org.abchip.mimo.biz.model.content.website.WebsitePackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	 ...
	 */
	@Override
	public EClass getWebAnalyticsConfig() {
		return webAnalyticsConfigEClass;
	}
	 ...
	 */
	@Override
	public EReference getWebAnalyticsConfig_WebAnalyticsType() {
		return (EReference)webAnalyticsConfigEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 */
	@Override
	public EReference getWebAnalyticsConfig_WebSite() {
		return (EReference)webAnalyticsConfigEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 */
	@Override
	public EAttribute getWebAnalyticsConfig_WebAnalyticsCode() {
		return (EAttribute)webAnalyticsConfigEClass.getEStructuralFeatures().get(2);
	}
	 ...
	 */
	@Override
	public EClass getWebAnalyticsType() {
		return webAnalyticsTypeEClass;
	}
	 ...
	 */
	@Override
	public EAttribute getWebAnalyticsType_WebAnalyticsTypeId() {
		return (EAttribute)webAnalyticsTypeEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 */
	@Override
	public EAttribute getWebAnalyticsType_Description() {
		return (EAttribute)webAnalyticsTypeEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 */
	@Override
	public EAttribute getWebAnalyticsType_HasTable() {
		return (EAttribute)webAnalyticsTypeEClass.getEStructuralFeatures().get(2);
	}
	 ...
	 */
	@Override
	public EReference getWebAnalyticsType_ParentType() {
		return (EReference)webAnalyticsTypeEClass.getEStructuralFeatures().get(3);
	}
	 ...
	 */
	@Override
	public EReference getWebSiteContent_WebSite() {
		return (EReference)webSiteContentEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 */
	@Override
	public EReference getWebSiteContent_Content() {
		return (EReference)webSiteContentEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 */
	@Override
	public EReference getWebSiteContent_WebSiteContentType() {
		return (EReference)webSiteContentEClass.getEStructuralFeatures().get(2);
	}
	 ...
	 */
	@Override
	public EAttribute getWebSiteContent_FromDate() {
		return (EAttribute)webSiteContentEClass.getEStructuralFeatures().get(3);
	}
	 ...
	 */
	@Override
	public EAttribute getWebSiteContent_ThruDate() {
		return (EAttribute)webSiteContentEClass.getEStructuralFeatures().get(4);
	}
	 ...
	 */
	@Override
	public EClass getWebSiteContentType() {
		return webSiteContentTypeEClass;
	}
	 ...
	 */
	@Override
	public EAttribute getWebSiteContentType_WebSiteContentTypeId() {
		return (EAttribute)webSiteContentTypeEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 */
	@Override
	public EAttribute getWebSiteContentType_Description() {
		return (EAttribute)webSiteContentTypeEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 */
	@Override
	public EAttribute getWebSiteContentType_HasTable() {
		return (EAttribute)webSiteContentTypeEClass.getEStructuralFeatures().get(2);
	}
	 ...
	 */
	@Override
	public EReference getWebSiteContentType_ParentType() {
	 ...
	 */
	@Override
	public EClass getWebSitePathAlias() {
		return webSitePathAliasEClass;
	}
	 ...
	 */
	@Override
	public EReference getWebSitePathAlias_WebSite() {
		return (EReference)webSitePathAliasEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 */
	@Override
	public EAttribute getWebSitePathAlias_PathAlias() {
		return (EAttribute)webSitePathAliasEClass.getEStructuralFeatures().get(2);
	}
	 ...
	 */
	@Override
	public EAttribute getWebSitePathAlias_FromDate() {
		return (EAttribute)webSitePathAliasEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 */
	@Override
	public EAttribute getWebSitePathAlias_AliasTo() {
		return (EAttribute)webSitePathAliasEClass.getEStructuralFeatures().get(3);
	}
	 ...
	 */
	@Override
	public EReference getWebSitePathAlias_Content() {
		return (EReference)webSitePathAliasEClass.getEStructuralFeatures().get(4);
	}
	 ...
	 */
	@Override
	public EAttribute getWebSitePathAlias_MapKey() {
		return (EAttribute)webSitePathAliasEClass.getEStructuralFeatures().get(5);
	}
	 ...
	 */
	@Override
	public EAttribute getWebSitePathAlias_ThruDate() {
		return (EAttribute)webSitePathAliasEClass.getEStructuralFeatures().get(6);
	}
	 ...
	 */
	@Override
	public EClass getWebSitePublishPoint() {
		return webSitePublishPointEClass;
	}
	 ...
	 */
	@Override
	public EAttribute getWebSitePublishPoint_LeftBarId() {
		return (EAttribute)webSitePublishPointEClass.getEStructuralFeatures().get(3);
	}
	 ...
	 */
	@Override
	public EAttribute getWebSitePublishPoint_LineLogo() {
		return (EAttribute)webSitePublishPointEClass.getEStructuralFeatures().get(4);
	}
	 ...
	 */
	@Override
	public EAttribute getWebSitePublishPoint_Logo() {
		return (EAttribute)webSitePublishPointEClass.getEStructuralFeatures().get(5);
	}
	 ...
	 */
	@Override
	public EAttribute getWebSitePublishPoint_MedallionLogo() {
		return (EAttribute)webSitePublishPointEClass.getEStructuralFeatures().get(6);
	}
	 ...
	 */
	@Override
	public EAttribute getWebSitePublishPoint_RightBarId() {
		return (EAttribute)webSitePublishPointEClass.getEStructuralFeatures().get(7);
	}
	 ...
	 */
	@Override
	public EAttribute getWebSitePublishPoint_StyleSheetFile() {
		return (EAttribute)webSitePublishPointEClass.getEStructuralFeatures().get(8);
	}
	 ...
	 */
	@Override
	public EAttribute getWebSitePublishPoint_TemplateTitle() {
		return (EAttribute)webSitePublishPointEClass.getEStructuralFeatures().get(9);
	}
	...
	public void createPackageContents() {
		...
		webAnalyticsConfigEClass = createEClass(WEB_ANALYTICS_CONFIG);
		createEReference(webAnalyticsConfigEClass, WEB_ANALYTICS_CONFIG__WEB_ANALYTICS_TYPE);
		createEReference(webAnalyticsConfigEClass, WEB_ANALYTICS_CONFIG__WEB_SITE);
		createEAttribute(webAnalyticsConfigEClass, WEB_ANALYTICS_CONFIG__WEB_ANALYTICS_CODE);

		webAnalyticsTypeEClass = createEClass(WEB_ANALYTICS_TYPE);
		createEAttribute(webAnalyticsTypeEClass, WEB_ANALYTICS_TYPE__WEB_ANALYTICS_TYPE_ID);
		...
		createEReference(webAnalyticsTypeEClass, WEB_ANALYTICS_TYPE__PARENT_TYPE);

		webSiteContentEClass = createEClass(WEB_SITE_CONTENT);
		createEReference(webSiteContentEClass, WEB_SITE_CONTENT__WEB_SITE);
		createEReference(webSiteContentEClass, WEB_SITE_CONTENT__CONTENT);
		createEReference(webSiteContentEClass, WEB_SITE_CONTENT__WEB_SITE_CONTENT_TYPE);
		createEAttribute(webSiteContentEClass, WEB_SITE_CONTENT__FROM_DATE);
		createEAttribute(webSiteContentEClass, WEB_SITE_CONTENT__THRU_DATE);

		webSiteContentTypeEClass = createEClass(WEB_SITE_CONTENT_TYPE);
		createEAttribute(webSiteContentTypeEClass, WEB_SITE_CONTENT_TYPE__WEB_SITE_CONTENT_TYPE_ID);
		...
		createEReference(webSiteContentTypeEClass, WEB_SITE_CONTENT_TYPE__PARENT_TYPE);

		webSitePathAliasEClass = createEClass(WEB_SITE_PATH_ALIAS);
		createEReference(webSitePathAliasEClass, WEB_SITE_PATH_ALIAS__WEB_SITE);
		createEAttribute(webSitePathAliasEClass, WEB_SITE_PATH_ALIAS__FROM_DATE);
		createEAttribute(webSitePathAliasEClass, WEB_SITE_PATH_ALIAS__PATH_ALIAS);
		createEAttribute(webSitePathAliasEClass, WEB_SITE_PATH_ALIAS__ALIAS_TO);
		createEReference(webSitePathAliasEClass, WEB_SITE_PATH_ALIAS__CONTENT);
		createEAttribute(webSitePathAliasEClass, WEB_SITE_PATH_ALIAS__MAP_KEY);
		...
		createEAttribute(webSitePublishPointEClass, WEB_SITE_PUBLISH_POINT__MEDALLION_LOGO);
		createEAttribute(webSitePublishPointEClass, WEB_SITE_PUBLISH_POINT__RIGHT_BAR_ID);
		createEAttribute(webSitePublishPointEClass, WEB_SITE_PUBLISH_POINT__STYLE_SHEET_FILE);
		createEAttribute(webSitePublishPointEClass, WEB_SITE_PUBLISH_POINT__TEMPLATE_TITLE);
	}
	...
	public void initializePackageContents() {
		...
		initEReference(getWebAnalyticsConfig_WebAnalyticsType(), this.getWebAnalyticsType(), null, "webAnalyticsType", null, 1, 1, WebAnalyticsConfig.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		getWebAnalyticsConfig_WebAnalyticsType().getEKeys().add(this.getWebAnalyticsType_WebAnalyticsTypeId());
		initEReference(getWebAnalyticsConfig_WebSite(), theWebsitePackage_1.getWebSite(), null, "webSite", null, 1, 1, WebAnalyticsConfig.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		getWebAnalyticsConfig_WebSite().getEKeys().add(theWebsitePackage_1.getWebSite_WebSiteId());
		...
		initEReference(getWebSiteContent_WebSite(), theWebsitePackage_1.getWebSite(), null, "webSite", null, 1, 1, WebSiteContent.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		getWebSiteContent_WebSite().getEKeys().add(theWebsitePackage_1.getWebSite_WebSiteId());
		initEReference(getWebSiteContent_Content(), theContentPackage.getContent(), null, "content", null, 1, 1, WebSiteContent.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		getWebSiteContent_Content().getEKeys().add(theContentPackage.getContent_ContentId());
		initEReference(getWebSiteContent_WebSiteContentType(), this.getWebSiteContentType(), null, "webSiteContentType", null, 1, 1, WebSiteContent.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		getWebSiteContent_WebSiteContentType().getEKeys().add(this.getWebSiteContentType_WebSiteContentTypeId());
		...
		initEAttribute(getWebSiteContent_ThruDate(), ecorePackage.getEDate(), "thruDate", null, 0, 1, WebSiteContent.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getWebSitePathAlias_WebSite(), theWebsitePackage_1.getWebSite(), null, "webSite", null, 1, 1, WebSitePathAlias.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		getWebSitePathAlias_WebSite().getEKeys().add(theWebsitePackage_1.getWebSite_WebSiteId());
		initEAttribute(getWebSitePathAlias_FromDate(), ecorePackage.getEDate(), "fromDate", null, 1, 1, WebSitePathAlias.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getWebSitePathAlias_AliasTo(), ecorePackage.getEString(), "aliasTo", null, 0, 1, WebSitePathAlias.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getWebSitePathAlias_Content(), theContentPackage.getContent(), null, "content", null, 0, 1, WebSitePathAlias.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		getWebSitePathAlias_Content().getEKeys().add(theContentPackage.getContent_ContentId());
		initEAttribute(getWebSitePathAlias_MapKey(), ecorePackage.getEString(), "mapKey", null, 0, 1, WebSitePathAlias.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getWebSitePublishPoint_MedallionLogo(), ecorePackage.getEString(), "medallionLogo", null, 0, 1, WebSitePublishPoint.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getWebSitePublishPoint_RightBarId(), ecorePackage.getEString(), "rightBarId", null, 0, 1, WebSitePublishPoint.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getWebSitePublishPoint_StyleSheetFile(), ecorePackage.getEString(), "styleSheetFile", null, 0, 1, WebSitePublishPoint.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getWebSitePublishPoint_TemplateTitle(), ecorePackage.getEString(), "templateTitle", null, 0, 1, WebSitePublishPoint.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
	...
	protected void createMimoentformatAnnotations() {
		...
		addAnnotation
		  (getWebSitePublishPoint_LeftBarId(),
		   source,
		   new String[] {
			   "length", "20"
		   });
		addAnnotation
		  (getWebSitePublishPoint_LineLogo(),
		   source,
		   new String[] {
			   "length", "255"
		   });
		addAnnotation
		  (getWebSitePublishPoint_Logo(),
		   source,
		   new String[] {
			   "length", "255"
		   });
		addAnnotation
		  (getWebSitePublishPoint_MedallionLogo(),
		   source,
		   new String[] {
			   "length", "255"
		   });
		addAnnotation
		  (getWebSitePublishPoint_RightBarId(),
		   source,
		   new String[] {
			   "length", "20"
		   });
		addAnnotation
		  (getWebSitePublishPoint_StyleSheetFile(),
		   source,
		   new String[] {
			   "length", "255"
		   });
		addAnnotation
		  (getWebSitePublishPoint_TemplateTitle(),
		   source,
		   new String[] {
			   "length", "255"
		   });
	...
	protected void createMimoentslotAnnotations() {
		...
		addAnnotation
		  (getWebAnalyticsConfig_WebAnalyticsType(),
		   source,
		   new String[] {
			   "key", "true"
		   });
		addAnnotation
		  (getWebAnalyticsConfig_WebSite(),
		   source,
		   new String[] {
			   "key", "true"
		   });
		addAnnotation
		  (getWebAnalyticsConfig_WebAnalyticsCode(),
		   source,
		   new String[] {
			   "help", "copy in here the analitics javascript code without the beginning- and end<script> tags"
		   });
		addAnnotation
		  (getWebSiteContent_WebSite(),
		   source,
		   new String[] {
			   "key", "true"
		   });
		addAnnotation
		  (getWebSiteContent_Content(),
		   source,
		   new String[] {
			   "key", "true"
		   });
		addAnnotation
		  (getWebSiteContent_WebSiteContentType(),
		   source,
		   new String[] {
			   "key", "true"
		   });
	...
	protected void createMimoentframeAnnotations() {
		...
		addAnnotation
		  (webAnalyticsConfigEClass,
		   source,
		   new String[] {
			   "title", "Web Analytics Configuration"
		   });
		addAnnotation
		  (webAnalyticsTypeEClass,
		   source,
		   new String[] {
			   "formula", "description"
		   });
		addAnnotation
		  (webSiteContentEClass,
		   source,
		   new String[] {
			   "title", "Web Site Content Associations"
		   });
		addAnnotation
		  (webSiteContentTypeEClass,
		   source,
		   new String[] {
