...
public interface PreferencePackage extends EPackage {
	 ...
	 * @ordered
	 */
	int WEB_USER_PREFERENCE__WEB_PREFERENCE_TYPE = EntityPackage.ENTITY_IDENTIFIABLE_FEATURE_COUNT + 4;
	 ...
	 * @ordered
	 */
	int WEB_USER_PREFERENCE__USER_LOGIN = EntityPackage.ENTITY_IDENTIFIABLE_FEATURE_COUNT + 5;
	 ...
	 * @ordered
	 */
	int WEB_USER_PREFERENCE__PARTY = EntityPackage.ENTITY_IDENTIFIABLE_FEATURE_COUNT + 6;
