...
public interface SupplierPackage extends EPackage {
	 ...
	 * @ordered
	 */
	int SUPPLIER_PRODUCT__PRODUCT = EntityPackage.ENTITY_IDENTIFIABLE_FEATURE_COUNT + 4;
	 ...
	 * @ordered
	 */
	int SUPPLIER_PRODUCT__PARTY = EntityPackage.ENTITY_IDENTIFIABLE_FEATURE_COUNT + 5;
	 ...
	 * @ordered
	 */
	int SUPPLIER_PRODUCT__CURRENCY_UOM = EntityPackage.ENTITY_IDENTIFIABLE_FEATURE_COUNT + 6;
	 ...
	 * @ordered
	 */
	int SUPPLIER_PRODUCT__QUANTITY_UOM = EntityPackage.ENTITY_IDENTIFIABLE_FEATURE_COUNT + 16;
	 ...
	 * @ordered
	 */
	int SUPPLIER_PRODUCT__SUPPLIER_PREF_ORDER = EntityPackage.ENTITY_IDENTIFIABLE_FEATURE_COUNT + 19;
	 ...
	 * @ordered
	 */
	int SUPPLIER_PRODUCT__SUPPLIER_RATING_TYPE = EntityPackage.ENTITY_IDENTIFIABLE_FEATURE_COUNT + 22;
