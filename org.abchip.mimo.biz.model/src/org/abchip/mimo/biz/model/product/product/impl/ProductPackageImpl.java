...
public class ProductPackageImpl extends EPackageImpl implements ProductPackage {
	...
	public void initializePackageContents() {
		...
		productMaintEClass.getESuperTypes().add(theEntityPackage_1.getEntityIdentifiable());
		productMaintEClass.getESuperTypes().add(theEntityPackage_1.getEntityInfo());
		productMaintTypeEClass.getESuperTypes().add(theEntityPackage_1.getEntityIdentifiable());
		productMaintTypeEClass.getESuperTypes().add(theEntityPackage_1.getEntityInfo());
		productMeterEClass.getESuperTypes().add(theEntityPackage_1.getEntityIdentifiable());
		productMeterEClass.getESuperTypes().add(theEntityPackage_1.getEntityInfo());
		productMeterTypeEClass.getESuperTypes().add(theEntityPackage_1.getEntityIdentifiable());
		productMeterTypeEClass.getESuperTypes().add(theEntityPackage_1.getEntityInfo());
