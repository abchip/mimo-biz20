...
public class PartyPackageImpl extends EPackageImpl implements PartyPackage {
	...
	public void initializePackageContents() {
		...
		g1 = createEGenericType(theEntityPackage_1.getEntityInfo());
		partyClassificationTypeEClass.getEGenericSuperTypes().add(g1);
		partyContentEClass.getESuperTypes().add(theEntityPackage_1.getEntityIdentifiable());
		partyContentEClass.getESuperTypes().add(theEntityPackage_1.getEntityInfo());
		partyContentTypeEClass.getESuperTypes().add(theEntityPackage_1.getEntityIdentifiable());
		partyContentTypeEClass.getESuperTypes().add(theEntityPackage_1.getEntityInfo());
