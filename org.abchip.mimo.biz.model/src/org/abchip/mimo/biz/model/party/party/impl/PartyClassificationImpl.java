 ...
 * </p>
 * <ul>
 *   <li>{@link org.abchip.mimo.biz.model.party.party.impl.PartyClassificationImpl#getCreatedStamp <em>Created Stamp</em>}</li>
...
public class PartyClassificationImpl extends EntityTypedImpl<PartyClassificationType> implements PartyClassification {
	...
	public void setFromDate(Date newFromDate) {
		eSet(PartyPackage.Literals.PARTY_CLASSIFICATION__FROM_DATE, newFromDate);
	}
	...
	public Date getThruDate() {
		return (Date)eGet(PartyPackage.Literals.PARTY_CLASSIFICATION__THRU_DATE, true);
	}
	...
	public void setThruDate(Date newThruDate) {
		eSet(PartyPackage.Literals.PARTY_CLASSIFICATION__THRU_DATE, newThruDate);
	}
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == EntityInfo.class) {
			switch (derivedFeatureID) {
				case PartyPackage.PARTY_CLASSIFICATION__CREATED_STAMP: return EntityPackage.ENTITY_INFO__CREATED_STAMP;
				case PartyPackage.PARTY_CLASSIFICATION__CREATED_TX_STAMP: return EntityPackage.ENTITY_INFO__CREATED_TX_STAMP;
				case PartyPackage.PARTY_CLASSIFICATION__LAST_UPDATED_STAMP: return EntityPackage.ENTITY_INFO__LAST_UPDATED_STAMP;
				case PartyPackage.PARTY_CLASSIFICATION__LAST_UPDATED_TX_STAMP: return EntityPackage.ENTITY_INFO__LAST_UPDATED_TX_STAMP;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == EntityInfo.class) {
			switch (baseFeatureID) {
				case EntityPackage.ENTITY_INFO__CREATED_STAMP: return PartyPackage.PARTY_CLASSIFICATION__CREATED_STAMP;
				case EntityPackage.ENTITY_INFO__CREATED_TX_STAMP: return PartyPackage.PARTY_CLASSIFICATION__CREATED_TX_STAMP;
				case EntityPackage.ENTITY_INFO__LAST_UPDATED_STAMP: return PartyPackage.PARTY_CLASSIFICATION__LAST_UPDATED_STAMP;
				case EntityPackage.ENTITY_INFO__LAST_UPDATED_TX_STAMP: return PartyPackage.PARTY_CLASSIFICATION__LAST_UPDATED_TX_STAMP;
				default: return -1;
			}
		}
