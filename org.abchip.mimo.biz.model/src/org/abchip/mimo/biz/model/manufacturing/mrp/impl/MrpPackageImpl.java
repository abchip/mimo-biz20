...
import org.abchip.mimo.biz.model.manufacturing.mrp.MrpFactory;
 ...
 * @generated
 */
public class MrpPackageImpl extends EPackageImpl implements MrpPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private EClass mrpEventEClass = null;
	 ...
	 * @generated
	 */
	private EClass mrpEventTypeEClass = null;
	 ...
	 * @see org.abchip.mimo.biz.model.manufacturing.mrp.MrpPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private MrpPackageImpl() {
		super(eNS_URI, MrpFactory.eINSTANCE);
	}
	 ...
	 *
	 * <p>This method is used to initialize {@link MrpPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static MrpPackage init() {
		if (isInited) return (MrpPackage)EPackage.Registry.INSTANCE.getEPackage(MrpPackage.eNS_URI);

		// Obtain or create and register package
		Object registeredMrpPackage = EPackage.Registry.INSTANCE.get(eNS_URI);
		MrpPackageImpl theMrpPackage = registeredMrpPackage instanceof MrpPackageImpl ? (MrpPackageImpl)registeredMrpPackage : new MrpPackageImpl();
		...
		theMrpPackage.freeze();

		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(MrpPackage.eNS_URI, theMrpPackage);
		return theMrpPackage;
	}
	 ...
	 */
	@Override
	public EClass getMrpEvent() {
		return mrpEventEClass;
	}
	 ...
	 */
	@Override
	public EAttribute getMrpEvent_EventDate() {
		return (EAttribute)mrpEventEClass.getEStructuralFeatures().get(2);
	}
	 ...
	 */
	@Override
	public EAttribute getMrpEvent_IsLate() {
		return (EAttribute)mrpEventEClass.getEStructuralFeatures().get(6);
	}
	 ...
	 */
	@Override
	public EAttribute getMrpEvent_Quantity() {
		return (EAttribute)mrpEventEClass.getEStructuralFeatures().get(7);
	}
	 ...
	 */
	@Override
	public EClass getMrpEventType() {
		return mrpEventTypeEClass;
	}
	 ...
	 */
	@Override
	public EAttribute getMrpEventType_MrpEventTypeId() {
		return (EAttribute)mrpEventTypeEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 */
	@Override
	public EAttribute getMrpEventType_Description() {
		return (EAttribute)mrpEventTypeEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 */
	@Override
	public MrpFactory getMrpFactory() {
		return (MrpFactory)getEFactoryInstance();
	}
	...
	public void createPackageContents() {
		...
		mrpEventTypeEClass = createEClass(MRP_EVENT_TYPE);
		createEAttribute(mrpEventTypeEClass, MRP_EVENT_TYPE__MRP_EVENT_TYPE_ID);
		createEAttribute(mrpEventTypeEClass, MRP_EVENT_TYPE__DESCRIPTION);
	}
	...
	public void initializePackageContents() {
		...
		MrpPackage theMrpPackage_1 = (MrpPackage)EPackage.Registry.INSTANCE.getEPackage(MrpPackage.eNS_URI);
		...
		initEReference(getMrpEvent_MrpEventTypeId(), theMrpPackage_1.getMrpEventType(), null, "mrpEventTypeId", null, 1, 1, MrpEvent.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		getMrpEvent_MrpEventTypeId().getEKeys().add(theMrpPackage_1.getMrpEventType_MrpEventTypeId());
		...
		initEAttribute(getMrpEvent_IsLate(), ecorePackage.getEBoolean(), "isLate", null, 0, 1, MrpEvent.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEClass(mrpEventTypeEClass, MrpEventType.class, "MrpEventType", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getMrpEventType_MrpEventTypeId(), ecorePackage.getEString(), "mrpEventTypeId", null, 1, 1, MrpEventType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getMrpEventType_Description(), ecorePackage.getEString(), "description", null, 0, 1, MrpEventType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
	...
	protected void createMimoentformatAnnotations() {
		...
		addAnnotation
		  (getMrpEventType_MrpEventTypeId(),
		   source,
		   new String[] {
			   "length", "20"
		   });
		addAnnotation
		  (getMrpEventType_Description(),
		   source,
		   new String[] {
			   "type", "description",
			   "length", "255"
