...
import org.abchip.mimo.biz.model.manufacturing.bom.BomFactory;
...
public class BomPackageImpl extends EPackageImpl implements BomPackage {
	 ...
	 * @generated
	 */
	private EClass productManufacturingRuleEClass = null;
	 ...
	 * @see org.abchip.mimo.biz.model.manufacturing.bom.BomPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	 ...
	 */
	@Override
	public EClass getProductManufacturingRule() {
		return productManufacturingRuleEClass;
	}
	 ...
	 */
	@Override
	public EAttribute getProductManufacturingRule_RuleId() {
		return (EAttribute)productManufacturingRuleEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 */
	@Override
	public EAttribute getProductManufacturingRule_Description() {
		return (EAttribute)productManufacturingRuleEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 */
	@Override
	public EAttribute getProductManufacturingRule_FromDate() {
		return (EAttribute)productManufacturingRuleEClass.getEStructuralFeatures().get(2);
	}
	 ...
	 */
	@Override
	public EReference getProductManufacturingRule_Product() {
	...
	public void createPackageContents() {
		...
		productManufacturingRuleEClass = createEClass(PRODUCT_MANUFACTURING_RULE);
		...
		createEReference(productManufacturingRuleEClass, PRODUCT_MANUFACTURING_RULE__PRODUCT);
	...
	public void initializePackageContents() {
		...
		productManufacturingRuleEClass.getESuperTypes().add(theEntityPackage_1.getEntityIdentifiable());
		productManufacturingRuleEClass.getESuperTypes().add(theEntityPackage_1.getEntityInfo());
		...
		initEReference(getProductManufacturingRule_Product(), theProductPackage.getProduct(), null, "product", null, 0, 1, ProductManufacturingRule.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		getProductManufacturingRule_Product().getEKeys().add(theProductPackage.getProduct_ProductId());
	...
	protected void createMimoentformatAnnotations() {
		...
		addAnnotation
		  (getProductManufacturingRule_RuleSeqId(),
		   source,
		   new String[] {
			   "length", "20"
		   });
