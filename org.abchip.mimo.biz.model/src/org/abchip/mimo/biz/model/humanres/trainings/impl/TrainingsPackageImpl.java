...
import org.abchip.mimo.biz.model.humanres.trainings.TrainingsFactory;
 ...
 * @generated
 */
public class TrainingsPackageImpl extends EPackageImpl implements TrainingsPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private EClass trainingRequestEClass = null;
	 ...
	 * @see org.abchip.mimo.biz.model.humanres.trainings.TrainingsPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private TrainingsPackageImpl() {
		super(eNS_URI, TrainingsFactory.eINSTANCE);
	}
	 ...
	 *
	 * <p>This method is used to initialize {@link TrainingsPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static TrainingsPackage init() {
		if (isInited) return (TrainingsPackage)EPackage.Registry.INSTANCE.getEPackage(TrainingsPackage.eNS_URI);

		// Obtain or create and register package
		Object registeredTrainingsPackage = EPackage.Registry.INSTANCE.get(eNS_URI);
		TrainingsPackageImpl theTrainingsPackage = registeredTrainingsPackage instanceof TrainingsPackageImpl ? (TrainingsPackageImpl)registeredTrainingsPackage : new TrainingsPackageImpl();
		...
		theTrainingsPackage.freeze();

		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(TrainingsPackage.eNS_URI, theTrainingsPackage);
		return theTrainingsPackage;
	}
	 ...
	 */
	@Override
	public EClass getTrainingRequest() {
		return trainingRequestEClass;
	}
	 ...
	 */
	@Override
	public EAttribute getTrainingRequest_TrainingRequestId() {
		return (EAttribute)trainingRequestEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 */
	@Override
	public TrainingsFactory getTrainingsFactory() {
		return (TrainingsFactory)getEFactoryInstance();
	}
	...
	public void createPackageContents() {
		...
		trainingRequestEClass = createEClass(TRAINING_REQUEST);
		createEAttribute(trainingRequestEClass, TRAINING_REQUEST__TRAINING_REQUEST_ID);
	}
	...
	public void initializePackageContents() {
		...
		trainingRequestEClass.getESuperTypes().add(theEntityPackage_1.getEntityIdentifiable());
		trainingRequestEClass.getESuperTypes().add(theEntityPackage_1.getEntityInfo());
