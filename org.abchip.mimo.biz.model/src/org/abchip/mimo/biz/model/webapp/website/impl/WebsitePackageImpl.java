...
import org.abchip.mimo.biz.model.webapp.website.WebsiteFactory;
...
public class WebsitePackageImpl extends EPackageImpl implements WebsitePackage {
	 ...
	 * @see org.abchip.mimo.biz.model.webapp.website.WebsitePackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public static WebsitePackage init() {
		...
		registeredPackage = EPackage.Registry.INSTANCE.getEPackage(org.abchip.mimo.biz.model.content.website.WebsitePackage.eNS_URI);
		org.abchip.mimo.biz.model.content.website.impl.WebsitePackageImpl theWebsitePackage_1 = (org.abchip.mimo.biz.model.content.website.impl.WebsitePackageImpl)(registeredPackage instanceof org.abchip.mimo.biz.model.content.website.impl.WebsitePackageImpl ? registeredPackage : org.abchip.mimo.biz.model.content.website.WebsitePackage.eINSTANCE);
	 ...
	 */
	@Override
	public EAttribute getWebPage_WebPageId() {
	 ...
	 */
	@Override
	public EAttribute getWebPage_PageName() {
	 ...
	 */
	@Override
	public EAttribute getWebSite_AllowProductStoreChange() {
	 ...
	 */
	@Override
	public EAttribute getWebSite_CookieDomain() {
	 ...
	 */
	@Override
	public EAttribute getWebSite_DisplayMaintenancePage() {
	 ...
	 */
	@Override
	public EAttribute getWebSite_EnableHttps() {
	 ...
	 */
	@Override
	public EAttribute getWebSite_HostedPathAlias() {
	 ...
	 */
	@Override
	public EAttribute getWebSite_HttpHost() {
	 ...
	 */
	@Override
	public EAttribute getWebSite_HttpPort() {
	 ...
	 */
	@Override
	public EAttribute getWebSite_HttpsHost() {
	 ...
	 */
	@Override
	public EAttribute getWebSite_HttpsPort() {
	 ...
	 */
	@Override
	public EAttribute getWebSite_IsDefault() {
	 ...
	 */
	@Override
	public EAttribute getWebSite_SecureContentPrefix() {
	 ...
	 */
	@Override
	public EAttribute getWebSite_SiteName() {
	 ...
	 */
	@Override
	public EAttribute getWebSite_StandardContentPrefix() {
	...
	public void createPackageContents() {
		...
		createEAttribute(webSiteEClass, WEB_SITE__ALLOW_PRODUCT_STORE_CHANGE);
		createEAttribute(webSiteEClass, WEB_SITE__COOKIE_DOMAIN);
		createEAttribute(webSiteEClass, WEB_SITE__DISPLAY_MAINTENANCE_PAGE);
		createEAttribute(webSiteEClass, WEB_SITE__ENABLE_HTTPS);
		createEAttribute(webSiteEClass, WEB_SITE__HOSTED_PATH_ALIAS);
		createEAttribute(webSiteEClass, WEB_SITE__HTTP_HOST);
		createEAttribute(webSiteEClass, WEB_SITE__HTTP_PORT);
	...
	public void initializePackageContents() {
		...
		initEAttribute(getWebSite_AllowProductStoreChange(), ecorePackage.getEBoolean(), "allowProductStoreChange", null, 1, 1, WebSite.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getWebSite_CookieDomain(), ecorePackage.getEString(), "cookieDomain", null, 0, 1, WebSite.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getWebSite_DisplayMaintenancePage(), ecorePackage.getEBoolean(), "displayMaintenancePage", null, 1, 1, WebSite.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getWebSite_EnableHttps(), ecorePackage.getEBooleanObject(), "enableHttps", null, 0, 1, WebSite.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getWebSite_HostedPathAlias(), ecorePackage.getEString(), "hostedPathAlias", null, 0, 1, WebSite.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getWebSite_HttpHost(), ecorePackage.getEString(), "httpHost", null, 0, 1, WebSite.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getWebSite_HttpPort(), ecorePackage.getEString(), "httpPort", null, 0, 1, WebSite.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
	...
	protected void createMimoentslotAnnotations() {
		...
		addAnnotation
		  (getWebSite_AllowProductStoreChange(),
		   source,
		   new String[] {
			   "help", "Allow change of ProductStore for this WebSite (webapp). Defaults to N (no)."
		   });
		addAnnotation
		  (getWebSite_DisplayMaintenancePage(),
		   source,
		   new String[] {
			   "help", "If set to Y, redirect user to site maintenance page"
		   });
		addAnnotation
		  (getWebSite_HostedPathAlias(),
		   source,
		   new String[] {
			   "help", "For WebSites hosted on webapp using the WebSiteFilter, indicates the path this WebSite will be hosted on"
		   });
		addAnnotation
