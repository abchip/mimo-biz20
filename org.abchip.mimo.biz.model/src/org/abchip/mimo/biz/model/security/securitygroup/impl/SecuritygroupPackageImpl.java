...
import org.abchip.mimo.biz.model.security.securitygroup.SecuritygroupFactory;
 ...
 * @generated
 */
public class SecuritygroupPackageImpl extends EPackageImpl implements SecuritygroupPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private EClass protectedViewEClass = null;
	 ...
	 * @generated
	 */
	private EClass securityGroupPermissionEClass = null;
	 ...
	 * @generated
	 */
	private EClass tarpittedLoginViewEClass = null;
	 ...
	 * @generated
	 */
	private EClass userLoginSecurityGroupEClass = null;
	 ...
	 * @see org.abchip.mimo.biz.model.security.securitygroup.SecuritygroupPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private SecuritygroupPackageImpl() {
		super(eNS_URI, SecuritygroupFactory.eINSTANCE);
	}
	 ...
	 *
	 * <p>This method is used to initialize {@link SecuritygroupPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static SecuritygroupPackage init() {
		if (isInited) return (SecuritygroupPackage)EPackage.Registry.INSTANCE.getEPackage(SecuritygroupPackage.eNS_URI);

		// Obtain or create and register package
		Object registeredSecuritygroupPackage = EPackage.Registry.INSTANCE.get(eNS_URI);
		SecuritygroupPackageImpl theSecuritygroupPackage = registeredSecuritygroupPackage instanceof SecuritygroupPackageImpl ? (SecuritygroupPackageImpl)registeredSecuritygroupPackage : new SecuritygroupPackageImpl();
		...
		theSecuritygroupPackage.freeze();

		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(SecuritygroupPackage.eNS_URI, theSecuritygroupPackage);
		return theSecuritygroupPackage;
	}
	 ...
	 */
	@Override
	public EClass getProtectedView() {
		return protectedViewEClass;
	}
	 ...
	 */
	@Override
	public EReference getProtectedView_Group() {
		return (EReference)protectedViewEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 */
	@Override
	public EAttribute getSecurityGroup_GroupId() {
	 ...
	 */
	@Override
	public EReference getSecurityGroupPermission_Group() {
		return (EReference)securityGroupPermissionEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 */
	@Override
	public EReference getSecurityGroupPermission_Permission() {
		return (EReference)securityGroupPermissionEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 */
	@Override
	public EAttribute getSecurityPermission_PermissionId() {
	 ...
	 */
	@Override
	public EClass getTarpittedLoginView() {
		return tarpittedLoginViewEClass;
	}
	 ...
	 */
	@Override
	public EAttribute getTarpittedLoginView_ViewNameId() {
		return (EAttribute)tarpittedLoginViewEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 */
	@Override
	public EAttribute getTarpittedLoginView_UserLoginId() {
		return (EAttribute)tarpittedLoginViewEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 */
	@Override
	public EAttribute getTarpittedLoginView_TarpitReleaseDateTime() {
		return (EAttribute)tarpittedLoginViewEClass.getEStructuralFeatures().get(2);
	}
	 ...
	 */
	@Override
	public EClass getUserLoginSecurityGroup() {
		return userLoginSecurityGroupEClass;
	}
	 ...
	 */
	@Override
	public EReference getUserLoginSecurityGroup_UserLogin() {
		return (EReference)userLoginSecurityGroupEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 */
	@Override
	public EReference getUserLoginSecurityGroup_Group() {
		return (EReference)userLoginSecurityGroupEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 */
	@Override
	public SecuritygroupFactory getSecuritygroupFactory() {
		return (SecuritygroupFactory)getEFactoryInstance();
	}
	...
	public void createPackageContents() {
		...
		createEReference(protectedViewEClass, PROTECTED_VIEW__GROUP);
		...
		createEReference(securityGroupPermissionEClass, SECURITY_GROUP_PERMISSION__GROUP);
		createEReference(securityGroupPermissionEClass, SECURITY_GROUP_PERMISSION__PERMISSION);
		...
		tarpittedLoginViewEClass = createEClass(TARPITTED_LOGIN_VIEW);
		createEAttribute(tarpittedLoginViewEClass, TARPITTED_LOGIN_VIEW__USER_LOGIN_ID);
		createEAttribute(tarpittedLoginViewEClass, TARPITTED_LOGIN_VIEW__VIEW_NAME_ID);
		...
		createEReference(userLoginSecurityGroupEClass, USER_LOGIN_SECURITY_GROUP__USER_LOGIN);
		createEReference(userLoginSecurityGroupEClass, USER_LOGIN_SECURITY_GROUP__GROUP);
	...
	public void initializePackageContents() {
		...
		initEReference(getProtectedView_Group(), this.getSecurityGroup(), null, "group", null, 1, 1, ProtectedView.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		getProtectedView_Group().getEKeys().add(this.getSecurityGroup_GroupId());
		...
		initEReference(getSecurityGroupPermission_Group(), this.getSecurityGroup(), null, "group", null, 1, 1, SecurityGroupPermission.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		getSecurityGroupPermission_Group().getEKeys().add(this.getSecurityGroup_GroupId());
		initEReference(getSecurityGroupPermission_Permission(), this.getSecurityPermission(), null, "permission", null, 1, 1, SecurityGroupPermission.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		getSecurityGroupPermission_Permission().getEKeys().add(this.getSecurityPermission_PermissionId());
		...
		initEClass(tarpittedLoginViewEClass, TarpittedLoginView.class, "TarpittedLoginView", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getTarpittedLoginView_UserLoginId(), ecorePackage.getEString(), "userLoginId", null, 1, 1, TarpittedLoginView.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getTarpittedLoginView_ViewNameId(), ecorePackage.getEString(), "viewNameId", null, 1, 1, TarpittedLoginView.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getUserLoginSecurityGroup_UserLogin(), theLoginPackage.getUserLogin(), null, "userLogin", null, 1, 1, UserLoginSecurityGroup.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		getUserLoginSecurityGroup_UserLogin().getEKeys().add(theLoginPackage.getUserLogin_UserLoginId());
		initEReference(getUserLoginSecurityGroup_Group(), this.getSecurityGroup(), null, "group", null, 1, 1, UserLoginSecurityGroup.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		getUserLoginSecurityGroup_Group().getEKeys().add(this.getSecurityGroup_GroupId());
	...
	protected void createMimoentformatAnnotations() {
		...
		addAnnotation
		  (getProtectedView_MaxHitsDuration(),
		   source,
		   new String[] {
			   "precision", "20",
			   "scale", "0"
		...
		addAnnotation
		  (getProtectedView_TarpitDuration(),
		   source,
		   new String[] {
			   "precision", "20",
			   "scale", "0"
		...
		addAnnotation
		  (getSecurityPermission_PermissionId(),
		   source,
		   new String[] {
			   "length", "60"
		   });
		...
		addAnnotation
		  (getTarpittedLoginView_ViewNameId(),
		   source,
		   new String[] {
			   "length", "60"
		   });
		addAnnotation
		  (getTarpittedLoginView_TarpitReleaseDateTime(),
		   source,
		   new String[] {
			   "precision", "20",
			   "scale", "0"
	...
	protected void createMimoentslotAnnotations() {
		...
		addAnnotation
		  (getProtectedView_ViewNameId(),
		   ...
		   new String[] {
			   "key", "true",
			   "help", "name of view to protect from data theft"
		   });
		addAnnotation
		  (getProtectedView_MaxHits(),
		   source,
		   new String[] {
			   "help", "number of hits before tarpitting a login for a view"
		   });
		addAnnotation
		  (getProtectedView_MaxHitsDuration(),
		   source,
		   new String[] {
			   "help", "period of time associated with maxHits (in seconds)"
		   });
		addAnnotation
		  (getProtectedView_TarpitDuration(),
		   source,
		...
		addAnnotation
		  (getSecurityGroupPermission_Permission(),
		   source,
		   new String[] {
			   "key", "true"
		   });
		...
		addAnnotation
		  (getTarpittedLoginView_ViewNameId(),
		   ...
		   new String[] {
			   "key", "true",
			   "help", "name of view protected from data theft"
		   });
		addAnnotation
		  (getTarpittedLoginView_TarpitReleaseDateTime(),
		   source,
		   new String[] {
			   "help", "Date/Time at which the login will gain anew access to the view (in milliseconds from midnight, January 1, 1970 UTC , 0 meaning no tarpit to allow the admin to free a view and to keep history"
		   });
		addAnnotation
		  (getUserLoginSecurityGroup_UserLogin(),
		   source,
		   new String[] {
			   "key", "true"
		   });
		addAnnotation
		  (getUserLoginSecurityGroup_Group(),
		   source,
		   new String[] {
			   "key", "true"
		   });
	...
	protected void createMimoentframeAnnotations() {
		...
		addAnnotation
		  (protectedViewEClass,
		   source,
		   new String[] {
			   "help", "Defines views protected from data leakage",
		...
		addAnnotation
		  (securityGroupEClass,
		   ...
		   new String[] {
			   ...
			   "dictionary", "SecurityEntityLabels",
			   "formula", "description"
		   });
		addAnnotation
		  (securityGroupPermissionEClass,
		   source,
		   new String[] {
			   "help", "Defines a permission available to a security group; there is no FK to SecurityPermission because we want to leave open the possibility of ad-hoc permissions, especially for the Entity Data Maintenance pages which have TONS of permissions",
		...
		addAnnotation
		  (tarpittedLoginViewEClass,
		   source,
		   new String[] {
			   "help", "Login View couple currently tarpitted : any access to the view for the login is denied",
			   "title", "Security Component - Protected View"
		   });
		addAnnotation
		  (userLoginSecurityGroupEClass,
		   source,
		   new String[] {
			   "help", "Maps a UserLogin to a security group",
			   "title", "Security Component - User Login Security Group"
		   });
	}

} //SecuritygroupPackageImpl
