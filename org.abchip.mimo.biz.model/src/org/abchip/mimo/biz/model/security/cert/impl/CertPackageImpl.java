...
import org.abchip.mimo.biz.model.security.cert.CertFactory;
 ...
 * @generated
 */
public class CertPackageImpl extends EPackageImpl implements CertPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private EClass x509IssuerProvisionEClass = null;
	 ...
	 * @see org.abchip.mimo.biz.model.security.cert.CertPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private CertPackageImpl() {
		super(eNS_URI, CertFactory.eINSTANCE);
	}
	 ...
	 *
	 * <p>This method is used to initialize {@link CertPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static CertPackage init() {
		if (isInited) return (CertPackage)EPackage.Registry.INSTANCE.getEPackage(CertPackage.eNS_URI);

		// Obtain or create and register package
		Object registeredCertPackage = EPackage.Registry.INSTANCE.get(eNS_URI);
		CertPackageImpl theCertPackage = registeredCertPackage instanceof CertPackageImpl ? (CertPackageImpl)registeredCertPackage : new CertPackageImpl();
		...
		theCertPackage.freeze();

		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(CertPackage.eNS_URI, theCertPackage);
		return theCertPackage;
	}
	 ...
	 */
	@Override
	public EClass getX509IssuerProvision() {
		return x509IssuerProvisionEClass;
	}
	 ...
	 */
	@Override
	public EAttribute getX509IssuerProvision_CertProvisionId() {
		return (EAttribute)x509IssuerProvisionEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 */
	@Override
	public EAttribute getX509IssuerProvision_CityLocality() {
		return (EAttribute)x509IssuerProvisionEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 */
	@Override
	public EAttribute getX509IssuerProvision_CommonName() {
		return (EAttribute)x509IssuerProvisionEClass.getEStructuralFeatures().get(2);
	}
	 ...
	 */
	@Override
	public EAttribute getX509IssuerProvision_Country() {
		return (EAttribute)x509IssuerProvisionEClass.getEStructuralFeatures().get(3);
	}
	 ...
	 */
	@Override
	public EAttribute getX509IssuerProvision_OrganizationName() {
		return (EAttribute)x509IssuerProvisionEClass.getEStructuralFeatures().get(4);
	}
	 ...
	 */
	@Override
	public EAttribute getX509IssuerProvision_OrganizationalUnit() {
		return (EAttribute)x509IssuerProvisionEClass.getEStructuralFeatures().get(5);
	}
	 ...
	 */
	@Override
	public EAttribute getX509IssuerProvision_SerialNumber() {
		return (EAttribute)x509IssuerProvisionEClass.getEStructuralFeatures().get(6);
	}
	 ...
	 */
	@Override
	public EAttribute getX509IssuerProvision_StateProvince() {
		return (EAttribute)x509IssuerProvisionEClass.getEStructuralFeatures().get(7);
	}
	...
	public CertFactory getCertFactory() {
		return (CertFactory)getEFactoryInstance();
	}
	...
	public void createPackageContents() {
		...
		x509IssuerProvisionEClass = createEClass(X509_ISSUER_PROVISION);
		createEAttribute(x509IssuerProvisionEClass, X509_ISSUER_PROVISION__CERT_PROVISION_ID);
		createEAttribute(x509IssuerProvisionEClass, X509_ISSUER_PROVISION__CITY_LOCALITY);
		createEAttribute(x509IssuerProvisionEClass, X509_ISSUER_PROVISION__COMMON_NAME);
		createEAttribute(x509IssuerProvisionEClass, X509_ISSUER_PROVISION__COUNTRY);
		createEAttribute(x509IssuerProvisionEClass, X509_ISSUER_PROVISION__ORGANIZATION_NAME);
		createEAttribute(x509IssuerProvisionEClass, X509_ISSUER_PROVISION__ORGANIZATIONAL_UNIT);
		createEAttribute(x509IssuerProvisionEClass, X509_ISSUER_PROVISION__SERIAL_NUMBER);
		createEAttribute(x509IssuerProvisionEClass, X509_ISSUER_PROVISION__STATE_PROVINCE);
	}
	...
	public void initializePackageContents() {
		...
		initEAttribute(getX509IssuerProvision_CommonName(), ecorePackage.getEString(), "commonName", null, 0, 1, X509IssuerProvision.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getX509IssuerProvision_Country(), ecorePackage.getEString(), "country", null, 0, 1, X509IssuerProvision.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getX509IssuerProvision_OrganizationName(), ecorePackage.getEString(), "organizationName", null, 0, 1, X509IssuerProvision.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getX509IssuerProvision_OrganizationalUnit(), ecorePackage.getEString(), "organizationalUnit", null, 0, 1, X509IssuerProvision.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getX509IssuerProvision_SerialNumber(), ecorePackage.getEString(), "serialNumber", null, 0, 1, X509IssuerProvision.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
	...
	protected void createMimoentformatAnnotations() {
		...
		addAnnotation
		  (getX509IssuerProvision_CityLocality(),
		   source,
		   new String[] {
			   "length", "255"
		   });
		addAnnotation
		  (getX509IssuerProvision_CommonName(),
		   source,
		   new String[] {
			   "length", "255"
		   });
		addAnnotation
		  (getX509IssuerProvision_Country(),
		   source,
		   new String[] {
			   "length", "255"
		   });
		addAnnotation
		  (getX509IssuerProvision_OrganizationName(),
		   source,
		   new String[] {
			   "length", "255"
		   });
		addAnnotation
		  (getX509IssuerProvision_OrganizationalUnit(),
		   source,
		   new String[] {
			   "length", "255"
		   });
		addAnnotation
		  (getX509IssuerProvision_SerialNumber(),
		   source,
		   new String[] {
			   "length", "255"
		   });
		addAnnotation
		  (getX509IssuerProvision_StateProvince(),
		   source,
		   new String[] {
			   "length", "255"
		   });
