...
public interface PartyPackage extends EPackage {
	 ...
	 * @ordered
	 */
	int GET_PARTY_DEFAULT__LOCALE = BizServicePackage.BIZ_SERVICE_REQUEST__LOCALE;
	 ...
	 * @ordered
	 */
	int GET_PARTY_DEFAULT__TENANT = BizServicePackage.BIZ_SERVICE_REQUEST__TENANT;
	 ...
	 * @ordered
	 */
	int GET_PARTY_DEFAULT__CONTEXT = BizServicePackage.BIZ_SERVICE_REQUEST__CONTEXT;
	 ...
	 * @ordered
	 */
	int GET_PARTY_DEFAULT__USER_LOGIN = BizServicePackage.BIZ_SERVICE_REQUEST__USER_LOGIN;
	 ...
	 * @ordered
	 */
	int GET_PARTY_DEFAULT_FEATURE_COUNT = BizServicePackage.BIZ_SERVICE_REQUEST_FEATURE_COUNT + 0;
