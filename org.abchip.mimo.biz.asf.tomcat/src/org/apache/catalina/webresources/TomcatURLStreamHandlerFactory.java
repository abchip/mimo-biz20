...
public class TomcatURLStreamHandlerFactory implements URLStreamHandlerFactory {
	...
	/**
	 * Obtain a reference to the singleton instance. It is recommended that callers
	 * check the value of {@link #isRegistered()} before using the returned
	 * instance.
	 *
	 ...
	 *
	 * @return <code>true</code> if the factory is already registered with the JVM
	 *         or was successfully registered as a result of this call.
	 *         <code>false</code> if the factory was disabled prior to this call.
	 */
	...
	/**
	 * Prevent this this factory from registering with the JVM. May be called more
	 * than once.
	 *
	 * @return <code>true</code> if the factory is already disabled or was
	 *         successfully disabled as a result of this call. <code>false</code> if
	 *         the factory was already registered prior to this call.
	 * 
	 */
	...
	/**
	 * Release references to any user provided factories that have been loaded using
	 * the provided class loader. Called during web application stop to prevent
	 * memory leaks.
	 *
	 * @param classLoader
		...
		if (register) {
			try {
				...
				try {
					...
					currentFactory.setParentFactory(this);
	 ...
	 * {@link URL#setURLStreamHandlerFactory(URLStreamHandlerFactory)} and Tomcat
	 * needs to register a handler, provide a mechanism to allow applications to
